...
\Needspace{2.5\baselineskip}\versal{1}~Multifariam, multisque modis olim Deus loquens patribus in prophetis~:
...
\Needspace{2.5\baselineskip}\versal{2}~Propterea abundantius oportet observare nos ea qu\ae\ audivimus, ne forte pereffluamus.
...
\Needspace{2.5\baselineskip}\versal{3}~Unde, fratres sancti, vocationis c\ae lestis participes, considerate Apostolum, et pontificem confessionis nostr\ae\ Jesum~:
...
\Needspace{2.5\baselineskip}\versal{4}~Timeamus ergo ne forte relicta pollicitatione intro\"eundi in requiem ejus, existimetur aliquis ex vobis deesse.
...
\Needspace{2.5\baselineskip}\versal{5}~Omnis namque pontifex ex hominibus assumptus, pro hominibus constituitur in iis qu\ae\ sunt ad Deum, ut offerat dona, et sacrificia pro peccatis~:
...
\Needspace{2.5\baselineskip}\versal{6}~Quapropter intermittentes inchoationis Christi sermonem, ad perfectiora feramur, non rursum jacientes fundamentum pœnitenti\ae\ ab operibus mortuis, et fidei ad Deum,
...
\Needspace{2.5\baselineskip}\versal{7}~Hic enim Melchisedech, rex Salem, sacerdos Dei summi, qui obviavit Abrah\ae\ regresso a c\ae de regum, et benedixit ei~:
...
\Needspace{2.5\baselineskip}\versal{8}~Capitulum autem super ea qu\ae\ dicuntur~: Talem habemus pontificem, qui consedit in dextera sedis magnitudinis in c\ae lis,
...
\Needspace{2.5\baselineskip}\versal{9}~Habuit quidem et prius justificationes cultur\ae , et Sanctum s\ae culare.
...
\Needspace{2.5\baselineskip}\versal{10}~Umbram enim habens lex futurorum bonorum, non ipsam imaginem rerum~: per singulos annos, eisdem ipsis hostiis quas offerunt indesinenter, numquam potest accedentes perfectos facere~:
...
\Needspace{2.5\baselineskip}\versal{11}~Est autem fides sperandarum substantia rerum, argumentum non apparentium.
...
\Needspace{2.5\baselineskip}\versal{12}~Ideoque et nos tantam habentes impositam nubem testium, deponentes omne pondus, et circumstans nos peccatum, per patientiam curramus ad propositum nobis certamen~:
...
\Needspace{2.5\baselineskip}\versal{13}~Caritas fraternitatis maneat in vobis,
