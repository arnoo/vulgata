...
\addcontentsline{toc}{subsection}{Habacuc}
\fancyhead[C]{\textsc{Habacuc}}

\Needspace{2.5\baselineskip}\versal{1}~\lettrine[lines=10,image=true,loversize=0.05,lraise=-0.03]{O}{}nus quod vidit Habacuc propheta.
...
\Needspace{2.5\baselineskip}\versal{3}~\lettrine[lines=10,image=true,loversize=0.05,lraise=-0.03]{O}{}ratio Habacuc prophet\ae , pro ignorantiis.
