{\centering \section*{Ecclesiasticus Jesu, filii Sirach}}\thispagestyle{empty}
\addcontentsline{toc}{subsection}{Ecclesiasticus}
\fancyhead[C]{\textsc{Ecclesiasticus}}
...
\Needspace{2.5\baselineskip}\versal{51}~\lettrine[lines=10,image=true,loversize=0.05,lraise=-0.03]{O}{}ratio Jesu filii Sirach. \begin{flushleft}\begin{verse}\vspace{6pt}Confitebor tibi, Domine rex,\\ et collaudabo te Deum salvatorem meum.\\
