...
\addcontentsline{toc}{subsection}{Petri I}
\fancyhead[C]{\textsc{Petri I}}

\Needspace{2.5\baselineskip}\versal{1}~\lettrine[lines=10,image=true,loversize=0.05,lraise=-0.03]{P}{}etrus Apostolus Jesu Christi, electis advenis dispersionis Ponti, Galati\ae , Cappadoci\ae , Asi\ae , et Bithyni\ae ,
...
\Needspace{2.5\baselineskip}\versal{2}~\lettrine[lines=10,image=true,loversize=0.05,lraise=-0.03]{D}{}eponentes igitur omnem malitiam, et omnem dolum, et simulationes, et invidias, et omnes detractiones,
...
\Needspace{2.5\baselineskip}\versal{3}~\lettrine[lines=10,image=true,loversize=0.05,lraise=-0.03]{S}{}imiliter et mulieres subdit\ae\ sint viris suis~: ut etsi qui non credunt verbo, per mulierem conversationem sine verbo lucrifiant~:
...
\Needspace{2.5\baselineskip}\versal{4}~\lettrine[lines=10,image=true,loversize=0.05,lraise=-0.03]{C}{}hristo igitur passo in carne, et vos eadem cogitatione armamini~: quia qui passus est in carne, desiit a peccatis~:
...
\Needspace{2.5\baselineskip}\versal{5}~\lettrine[lines=10,image=true,loversize=0.05,lraise=-0.03]{S}{}eniores ergo, qui in vobis sunt, obsecro, consenior et testis Christi passionum~: qui et ejus, qu\ae\ in futuro revelanda est, glori\ae\ communicator~:
