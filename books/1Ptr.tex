...
\Needspace{2.5\baselineskip}\versal{1}~Petrus Apostolus Jesu Christi, electis advenis dispersionis Ponti, Galati\ae , Cappadoci\ae , Asi\ae , et Bithyni\ae ,
...
\Needspace{2.5\baselineskip}\versal{2}~Deponentes igitur omnem malitiam, et omnem dolum, et simulationes, et invidias, et omnes detractiones,
...
\Needspace{2.5\baselineskip}\versal{3}~Similiter et mulieres subdit\ae\ sint viris suis~: ut etsi qui non credunt verbo, per mulierem conversationem sine verbo lucrifiant~:
...
\Needspace{2.5\baselineskip}\versal{4}~Christo igitur passo in carne, et vos eadem cogitatione armamini~: quia qui passus est in carne, desiit a peccatis~:
...
\Needspace{2.5\baselineskip}\versal{5}~Seniores ergo, qui in vobis sunt, obsecro, consenior et testis Christi passionum~: qui et ejus, qu\ae\ in futuro revelanda est, glori\ae\ communicator~:
