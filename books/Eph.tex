...
\Needspace{2.5\baselineskip}\versal{1}~Paulus Apostolus Jesu Christi per voluntatem Dei, omnibus sanctis qui sunt Ephesi, et fidelibus in Christo Jesu.
...
\Needspace{2.5\baselineskip}\versal{2}~Et vos, cum essetis mortui delictis et peccatis vestris,
...
\Needspace{2.5\baselineskip}\versal{3}~Hujus rei gratia, ego Paulus vinctus Christi Jesu, pro vobis gentibus,
...
\Needspace{2.5\baselineskip}\versal{4}~Obsecro itaque vos ego vinctus in Domino, ut digne ambuletis vocatione, qua vocati estis,
...
\Needspace{2.5\baselineskip}\versal{5}~Estote ergo imitatores Dei, sicut filii carissimi,
...
\Needspace{2.5\baselineskip}\versal{6}~Filii, obedite parentibus vestris in Domino~: hoc enim justum est.
