...
\Needspace{2.5\baselineskip}\versal{1}~In mense octavo, in anno secundo Darii regis, factum est verbum Domini ad Zachariam filium Barachi\ae\ filii Addo prophetam, dicens~:
...
\Needspace{2.5\baselineskip}\versal{2}~Et levavi oculos meos, et vidi, et ecce vir, et in manu ejus funiculus mensorum.
...
\Needspace{2.5\baselineskip}\versal{3}~Et ostendit mihi Dominus Jesum sacerdotem magnum, stantem coram angelo Domini~: et Satan stabat a dextris ejus ut adversaretur ei.
...
\Needspace{2.5\baselineskip}\versal{4}~Et reversus est angelus qui loquebatur in me, et suscitavit me quasi virum qui suscitatur de somno suo.
...
\Needspace{2.5\baselineskip}\versal{5}~Et conversus sum, et levavi oculos meos, et vidi, et ecce volumen volans.
...
\Needspace{2.5\baselineskip}\versal{6}~Et conversus sum, et levavi oculos meos, et vidi~: et ecce quatuor quadrig\ae\ egredientes de medio duorum montium~: et montes, montes \ae rei.
...
\Needspace{2.5\baselineskip}\versal{7}~Et factum est in anno quarto Darii regis, factum est verbum Domini ad Zachariam, in quarta mensis noni, qui est Casleu.
...
\Needspace{2.5\baselineskip}\versal{8}~Et factum est verbum Domini exercituum, dicens~:
...
\Needspace{2.5\baselineskip}\versal{12}~Onus verbi Domini super Isra\"el. \begin{flushleft}\begin{verse}\vspace{6pt}Dicit Dominus extendens c\ae lum, et fundans terram,\\ et fingens spiritum hominis in eo~:\\
...
\Needspace{2.5\baselineskip}\versal{14}~Ecce venient dies Domini, et dividentur spolia tua in medio tui.
