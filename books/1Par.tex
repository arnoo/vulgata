...
\Needspace{2.5\baselineskip}\versal{1}~Adam, Seth, Enos,
...
\Needspace{2.5\baselineskip}\versal{2}~Filii autem Isra\"el~: Ruben, Simeon, Levi, Juda, Issachar, et Zabulon,
...
\Needspace{2.5\baselineskip}\versal{3}~David vero hos habuit filios, qui ei nati sunt in Hebron~: primogenitum Amnon ex Achinoam Jezrahelitide, secundum Daniel de Abigail Carmelitide,
...
\Needspace{2.5\baselineskip}\versal{4}~Filii Juda~: Phares, Hesron, et Charmi, et Hur, et Sobal.
...
\Needspace{2.5\baselineskip}\versal{5}~Filii quoque Ruben primogeniti Isra\"el. (Ipse quippe fuit primogenitus ejus~: sed cum violasset thorum patris sui, data sunt primogenita ejus filiis Joseph filii Isra\"el, et non est ille reputatus in primogenitum.
...
\Needspace{2.5\baselineskip}\versal{6}~Filii Levi~: Gerson, Caath, et Merari.
...
\Needspace{2.5\baselineskip}\versal{7}~Porro filii Issachar~: Thola, et Phua, Jasub, et Simeron, quatuor.
...
\Needspace{2.5\baselineskip}\versal{8}~Benjamin autem genuit Bale primogenitum suum, Asbel secundum, Ahara tertium,
...
\Needspace{2.5\baselineskip}\versal{9}~Universus ergo Isra\"el dinumeratus est, et summa eorum scripta est in libro regum Isra\"el et Juda~: translatique sunt in Babylonem propter delictum suum.
...
\Needspace{2.5\baselineskip}\versal{10}~Philisthiim autem pugnabant contra Isra\"el, fugeruntque viri Isra\"el Pal\ae sthinos, et ceciderunt vulnerati in monte Gelbo\"e.
...
\Needspace{2.5\baselineskip}\versal{11}~Congregatus est igitur omnis Isra\"el ad David in Hebron, dicens~: Os tuum sumus, et caro tua.
...
\Needspace{2.5\baselineskip}\versal{12}~Hi quoque venerunt ad David in Siceleg, cum adhuc fugeret Saul filium Cis, qui erant fortissimi et egregii pugnatores,
...
\Needspace{2.5\baselineskip}\versal{13}~Iniit autem consilium David cum tribunis, et centurionibus, et universis principibus,
...
\Needspace{2.5\baselineskip}\versal{14}~Misit quoque Hiram rex Tyri nuntios ad David, et ligna cedrina, et artifices parietum, lignorumque, ut \ae dificarent ei domum.
...
\Needspace{2.5\baselineskip}\versal{15}~Fecit quoque sibi domos in civitate David~: et \ae dificavit locum arc\ae\ Dei, tetenditque ei tabernaculum.
...
\Needspace{2.5\baselineskip}\versal{16}~Attulerunt igitur arcam Dei, et constituerunt eam in medio tabernaculi quod tetenderat ei David~: et obtulerunt holocausta et pacifica coram Deo.
...
\Needspace{2.5\baselineskip}\versal{17}~Cum autem habitaret David in domo sua, dixit ad Nathan prophetam~: Ecce ego habito in domo cedrina~: arca autem fœderis Domini sub pellibus est.
...
\Needspace{2.5\baselineskip}\versal{18}~Factum est autem post h\ae c, ut percuteret David Philisthiim, et humiliaret eos, et tolleret Geth et filias ejus de manu Philisthiim,
...
\Needspace{2.5\baselineskip}\versal{19}~Accidit autem ut moreretur Naas rex filiorum Ammon, et regnaret filius ejus pro eo.
...
\Needspace{2.5\baselineskip}\versal{20}~Factum est autem post anni circulum, eo tempore quo solent reges ad bella procedere, congregavit Joab exercitum, et robur militi\ae , et vastavit terram filiorum Ammon~: perrexitque et obsedit Rabba. Porro David manebat in Jerusalem, quando Joab percussit Rabba et destruxit eam.
...
\Needspace{2.5\baselineskip}\versal{21}~Consurrexit autem Satan contra Isra\"el, et concitavit David ut numeraret Isra\"el.
...
\Needspace{2.5\baselineskip}\versal{22}~Dixitque David~: H\ae c est domus Dei, et hoc altare in holocaustum Isra\"eli.
...
\Needspace{2.5\baselineskip}\versal{23}~Igitur David, senex et plenus dierum, regem constituit Salomonem filium suum super Isra\"el.
...
\Needspace{2.5\baselineskip}\versal{24}~Porro filiis Aaron h\ae\ partitiones erant. Filii Aaron~: Nadab, et Abiu, et Eleazar, et Ithamar.
...
\Needspace{2.5\baselineskip}\versal{25}~Igitur David et magistratus exercitus segregaverunt in ministerium filios Asaph, et Heman, et Idithun, qui prophetarent in citharis, et psalteriis, et cymbalis secundum numerum suum, dedicato sibi officio servientes.
...
\Needspace{2.5\baselineskip}\versal{26}~Divisiones autem janitorum~: de Coritis Meselemia, filius Core, de filiis Asaph.
...
\Needspace{2.5\baselineskip}\versal{27}~Filii autem Isra\"el secundum numerum suum, principes familiarum, tribuni, et centuriones, et pr\ae fecti, qui ministrabant regi juxta turmas suas, ingredientes et egredientes per singulos menses in anno, viginti quatuor millibus singuli pr\ae erant.
...
\Needspace{2.5\baselineskip}\versal{29}~Locutusque est David rex ad omnem ecclesiam~: Salomonem filium meum unum elegit Deus, adhuc puerum et tenellum~: opus namque grande est, neque enim homini pr\ae paratur habitatio, sed Deo.
