...
\Needspace{2.5\baselineskip}\versal{1}~Paulus servus Dei, Apostolus autem Jesu Christi secundum fidem electorum Dei, et agnitionem veritatis, qu\ae\ secundum pietatem est
...
\Needspace{2.5\baselineskip}\versal{2}~Tu autem loquere qu\ae\ decent sanam doctrinam~:
...
\Needspace{2.5\baselineskip}\versal{3}~Admone illos principibus, et potestatibus subditos esse, dicto obedire, ad omne opus bonum paratos esse~:
