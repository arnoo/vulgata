{\centering \section*{Prophetia Sophoniæ}}\thispagestyle{empty}
\addcontentsline{toc}{subsection}{Sophonias}
\fancyhead[C]{\textsc{Sophonias}}

\Needspace{2.5\baselineskip}\versal{1}~\lettrine[lines=10,image=true,loversize=0.05,lraise=-0.03]{V}{}erbum Domini quod factum est ad Sophoniam, filium Chusi, filii Godoli\ae , filii Amari\ae , filii Ezeci\ae , in diebus Josi\ae , filii Amon, regis Jud\ae .
