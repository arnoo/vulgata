...
\Needspace{2.5\baselineskip}\versal{1}~Paulus, Apostolus Jesu Christi per voluntatem Dei, et Timotheus frater, ecclesi\ae\ Dei, qu\ae\ est Corinthi cum omnibus sanctis, qui sunt in universa Achaia.
...
\Needspace{2.5\baselineskip}\versal{2}~Statui autem hoc ipsum apud me, ne iterum in tristitia venirem ad vos.
...
\Needspace{2.5\baselineskip}\versal{3}~Incipimus iterum nosmetipsos commendare~? aut numquid egemus (sicut quidam) commendatitiis epistolis ad vos, aut ex vobis~?
...
\Needspace{2.5\baselineskip}\versal{4}~Ideo habentes administrationem, juxta quod misericordiam consecuti sumus, non deficimus,
...
\Needspace{2.5\baselineskip}\versal{5}~Scimus enim quoniam si terrestris domus nostra hujus habitationis dissolvatur, quod \ae dificationem ex Deo habemus, domum non manufactam, \ae ternam in c\ae lis.
...
\Needspace{2.5\baselineskip}\versal{6}~Adjuvantes autem exhortamur ne in vacuum gratiam Dei recipiatis.
...
\Needspace{2.5\baselineskip}\versal{7}~Has ergo habentes promissiones, carissimi, mundemus nos ab omni inquinamento carnis et spiritus, perficientes sanctificationem in timore Dei.
...
\Needspace{2.5\baselineskip}\versal{8}~Notam autem facimus vobis, fratres, gratiam Dei, qu\ae\ data est in ecclesiis Macedoni\ae~:
...
\Needspace{2.5\baselineskip}\versal{9}~Nam de ministerio, quod fit in sanctos ex abundanti est mihi scribere vobis.
...
\Needspace{2.5\baselineskip}\versal{10}~Ipse autem ego Paulus obsecro vos per mansuetudinem et modestiam Christi, qui in facie quidem humilis sum inter vos, absens autem confido in vos.
...
\Needspace{2.5\baselineskip}\versal{11}~Utinam sustineretis modicum quid insipienti\ae\ me\ae , sed et supportare me~:
...
\Needspace{2.5\baselineskip}\versal{12}~Si gloriari oportet (non expedit quidem), veniam autem ad visiones et revelationes Domini.
...
\Needspace{2.5\baselineskip}\versal{13}~Ecce tertio hoc venio ad vos~: in ore duorum vel trium testium stabit omne verbum.
