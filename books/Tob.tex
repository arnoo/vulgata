...
\Needspace{2.5\baselineskip}\versal{1}~Tobias ex tribu et civitate Nephthali (qu\ae\ est in superioribus Galil\ae \ae\ supra Naasson, post viam qu\ae\ ducit ad occidentem, in sinistro habens civitatem Sephet)
...
\Needspace{2.5\baselineskip}\versal{2}~Post h\ae c vero, cum esset dies festus Domini, et factum esset prandium bonum in domo Tobi\ae ,
...
\Needspace{2.5\baselineskip}\versal{3}~Tunc Tobias ingemuit, et cœpit orare cum lacrimis,
...
\Needspace{2.5\baselineskip}\versal{4}~Igitur cum Tobias putaret orationem suam exaudiri ut mori potuisset, vocavit ad se Tobiam filium suum,
...
\Needspace{2.5\baselineskip}\versal{5}~Tunc respondit Tobias patri suo, et dixit~: Omnia qu\ae cumque pr\ae cepisti mihi faciam, pater.
...
\Needspace{2.5\baselineskip}\versal{6}~Profectus est autem Tobias, et canis secutus est eum, et mansit prima mansione juxta fluvium Tigris.
...
\Needspace{2.5\baselineskip}\versal{7}~Ingressi sunt autem ad Raguelem, et suscepit eos Raguel cum gaudio.
...
\Needspace{2.5\baselineskip}\versal{8}~Postquam vero cœnaverunt, introduxerunt juvenem ad eam.
...
\Needspace{2.5\baselineskip}\versal{9}~Tunc vocavit Tobias angelum ad se, quem quidem hominem existimabat, dixitque ei~: Azaria frater, peto ut auscultes verba mea.
...
\Needspace{2.5\baselineskip}\versal{10}~Cum vero moras faceret Tobias, causa nuptiarum, sollicitus erat pater ejus Tobias, dicens~: Putas quare moratur filius meus, aut quare detentus est ibi~?
...
\Needspace{2.5\baselineskip}\versal{11}~Cumque reverterentur, pervenerunt ad Charan, qu\ae\ est in medio itinere contra Niniven, undecimo die.
...
\Needspace{2.5\baselineskip}\versal{12}~Tunc vocavit ad se Tobias filium suum, dixitque ei~: Quid possumus dare viro isti sancto, qui venit tecum~?
...
\Needspace{2.5\baselineskip}\versal{13}~Aperiens autem Tobias senior os suum, benedixit Dominum, et dixit~: \begin{flushleft}\begin{verse}\vspace{6pt}Magnus es, Domine, in \ae ternum,\\ et in omnia s\ae cula regnum tuum~:\\
...
\Needspace{2.5\baselineskip}\versal{14}~Et consummati sunt sermones Tobi\ae . Et postquam illuminatus est Tobias, vixit annis quadraginta duobus, et vidit filios nepotum suorum.
