...
\Needspace{2.5\baselineskip}\versal{1}~Jacobus, Dei et Domini nostri Jesu Christi servus, duodecim tribubus, qu\ae\ sunt in dispersione, salutem.
...
\Needspace{2.5\baselineskip}\versal{2}~Fratres mei, nolite in personarum acceptione habere fidem Domini nostri Jesu Christi glori\ae .
...
\Needspace{2.5\baselineskip}\versal{3}~Nolite plures magistri fieri fratres mei, scientes quoniam majus judicium sumitis.
...
\Needspace{2.5\baselineskip}\versal{4}~Unde bella et lites in vobis~? nonne hinc~: ex concupiscentiis vestris, qu\ae\ militant in membris vestris~?
...
\Needspace{2.5\baselineskip}\versal{5}~Agite nunc divites, plorate ululantes in miseriis vestris, qu\ae\ advenient vobis.
