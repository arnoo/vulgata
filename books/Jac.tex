...
\bchapter{1}
\lettrine[lines=6,image=true,loversize=0.05,lraise=-0.03]{J}{}acobus, Dei et Domini nostri Jesu Christi servus, duodecim tribubus, qu\ae\ sunt in dispersione, salutem.
...
\bchapter{2}
\lettrine[lines=3,image=true,loversize=0.05,lraise=-0.03]{F}{}ratres mei, nolite in personarum acceptione habere fidem Domini nostri Jesu Christi glori\ae .
...
\bchapter{3}
\lettrine[lines=3,image=true,loversize=0.05,lraise=-0.03]{N}{}olite plures magistri fieri fratres mei, scientes quoniam majus judicium sumitis.
...
\bchapter{4}
\lettrine[lines=3,image=true,loversize=0.05,lraise=-0.03]{U}{}nde bella et lites in vobis~? nonne hinc~: ex concupiscentiis vestris, qu\ae\ militant in membris vestris~?
...
\bchapter{5}
\lettrine[lines=3,image=true,loversize=0.05,lraise=-0.03]{A}{}gite nunc divites, plorate ululantes in miseriis vestris, qu\ae\ advenient vobis.
