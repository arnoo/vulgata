{\centering \section*{Prophetia Joël}}\thispagestyle{empty}
\addcontentsline{toc}{subsection}{Joel}
\fancyhead[C]{\textsc{Joel}}

\Needspace{2.5\baselineskip}\versal{1}~\lettrine[lines=10,image=true,loversize=0.05,lraise=-0.03]{V}{}erbum Domini, quod factum est ad Jo\"el, filium Phatuel.
...
\Needspace{2.5\baselineskip}\versal{2}\begin{flushleft}\begin{verse}\vspace{-19pt}Canite tuba in Sion,\\ ululate in monte sancto meo,\\ conturbentur omnes habitatores terr\ae~:\\ quia venit dies Domini, quia prope est.\\
...
\begin{flushleft}\begin{verse}${}^{18}$~Zelatus est Dominus terram suam,\\ et pepercit populo suo.\\
...
\begin{flushleft}\begin{verse}${}^{28}$~Et erit post h\ae c~:\\ effundam spiritum meum super omnem carnem,\\ et prophetabunt filii vestri et fili\ae\ vestr\ae~:\\ senes vestri somnia somniabunt,\\ et juvenes vestri visiones videbunt.\\
...
\Needspace{2.5\baselineskip}\versal{3}\begin{flushleft}\begin{verse}\vspace{-19pt}Quia ecce in diebus illis, et in tempore illo,\\ cum convertero captivitatem Juda et Jerusalem,\\
