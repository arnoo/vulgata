...
\Needspace{2.5\baselineskip}\versal{1}~Vocavit autem Moysen, et locutus est ei Dominus de tabernaculo testimonii, dicens~:
...
\Needspace{2.5\baselineskip}\versal{2}~Anima cum obtulerit oblationem sacrificii Domino, simila erit ejus oblatio~; fundetque super eam oleum, et ponet thus,
...
\Needspace{2.5\baselineskip}\versal{3}~Quod si hostia pacificorum fuerit ejus oblatio, et de bobus voluerit offerre, marem sive feminam, immaculata offeret coram Domino.
...
\Needspace{2.5\baselineskip}\versal{4}~Locutusque est Dominus ad Moysen, dicens~:
...
\Needspace{2.5\baselineskip}\versal{5}~Si peccaverit anima, et audierit vocem jurantis, testisque fuerit quod aut ipse vidit, aut conscius est~: nisi indicaverit, portabit iniquitatem suam.
...
\Needspace{2.5\baselineskip}\versal{6}~Locutus est Dominus ad Moysen, dicens~:
...
\Needspace{2.5\baselineskip}\versal{7}~H\ae c quoque lex hosti\ae\ pro delicto, Sancta sanctorum est~:
...
\Needspace{2.5\baselineskip}\versal{9}~Facto autem octavo die, vocavit Moyses Aaron, et filios ejus, ac majores natu Isra\"el, dixitque ad Aaron~:
...
\Needspace{2.5\baselineskip}\versal{10}~Arreptisque Nadab et Abiu filii Aaron thuribulis, posuerunt ignem, et incensum desuper, offerentes coram Domino ignem alienum~: quod eis pr\ae ceptum non erat.
...
\Needspace{2.5\baselineskip}\versal{11}~Locutusque est Dominus ad Moysen et Aaron, dicens~:
...
\Needspace{2.5\baselineskip}\versal{12}~Locutusque est Dominus ad Moysen, dicens~:
...
\Needspace{2.5\baselineskip}\versal{13}~Locutusque est Dominus ad Moysen, et Aaron, dicens~:
...
\Needspace{2.5\baselineskip}\versal{14}~Locutusque est Dominus ad Moysen, dicens~:
...
\Needspace{2.5\baselineskip}\versal{15}~Locutusque est Dominus ad Moysen et Aaron, dicens~:
...
\Needspace{2.5\baselineskip}\versal{16}~Locutusque est Dominus ad Moysen post mortem duorum filiorum Aaron, quando offerentes ignem alienum interfecti sunt~:
...
\Needspace{2.5\baselineskip}\versal{18}~Locutus est Dominus ad Moysen, dicens~:
...
\Needspace{2.5\baselineskip}\versal{19}~Locutus est Dominus ad Moysen, dicens~:
...
\Needspace{2.5\baselineskip}\versal{20}~Locutusque est Dominus ad Moysen, dicens~:
...
\Needspace{2.5\baselineskip}\versal{21}~Dixit quoque Dominus ad Moysen~: Loquere ad sacerdotes filios Aaron, et dices ad eos~: Ne contaminetur sacerdos in mortibus civium suorum,
...
\Needspace{2.5\baselineskip}\versal{22}~Locutus quoque est Dominus ad Moysen, dicens~:
...
\Needspace{2.5\baselineskip}\versal{23}~Locutusque est Dominus ad Moysen, dicens~:
...
\Needspace{2.5\baselineskip}\versal{24}~Et locutus est Dominus ad Moysen, dicens~:
...
\Needspace{2.5\baselineskip}\versal{25}~Locutusque est Dominus ad Moysen in monte Sinai, dicens~:
...
\Needspace{2.5\baselineskip}\versal{26}~Ego Dominus Deus vester~: non facietis vobis idolum, et sculptile, nec titulos erigetis, nec insignem lapidem ponetis in terra vestra, ut adoretis eum. Ego enim sum Dominus Deus vester.
...
\Needspace{2.5\baselineskip}\versal{27}~Locutusque est Dominus ad Moysen, dicens~:
