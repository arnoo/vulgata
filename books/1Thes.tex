...
\Needspace{2.5\baselineskip}\versal{1}~Paulus, et Silvanus, et Timotheus ecclesi\ae\ Thessalonicensium in Deo Patre, et Domino Jesu Christo.
...
\Needspace{2.5\baselineskip}\versal{2}~Nam ipsi scitis, fratres, introitum nostrum ad vos, quia non inanis fuit~:
...
\Needspace{2.5\baselineskip}\versal{3}~Propter quod non sustinentes amplius, placuit nobis remanere Athenis, solis~:
...
\Needspace{2.5\baselineskip}\versal{4}~De cetero ergo, fratres, rogamus vos et obsecramus in Domino Jesu, ut quemadmodum accepistis a nobis quomodo oporteat vos ambulare, et placere Deo, sic et ambuletis ut abundetis magis.
...
\Needspace{2.5\baselineskip}\versal{5}~De temporibus autem, et momentis, fratres, non indigetis ut scribamus vobis.
