\bbook{Prophetia Michææ}
{Michæa}{images/genese_heading}
\addcontentsline{toc}{subsection}{Michæa}

\Needspace{2.5\baselineskip}\versal{1}~\lettrine[lines=10,image=true,loversize=0.05,lraise=-0.03]{V}{}erbum Domini, quod factum est ad Mich\ae am Morasthiten, in diebus Joathan, Achaz, et Ezechi\ae , regum Juda, quod vidit super Samariam et Jerusalem.
...
\Needspace{2.5\baselineskip}\versal{2}\begin{flushleft}\begin{verse}\vspace{-19pt}V\ae\ qui cogitatis inutile,\\ et operamini malum in cubilibus vestris~!\\ In luce matutina faciunt illud,\\ quoniam contra Deum est manus eorum.\\
...
\Needspace{2.5\baselineskip}\versal{3}\begin{flushleft}\begin{verse}\vspace{-19pt}Et dixi~: Audite, princeps Jacob,\\ et duces domus Isra\"el~:\\ numquid non vestrum est scire judicium,\\
...
\Needspace{2.5\baselineskip}\versal{4}\begin{flushleft}\begin{verse}\vspace{-19pt}Et erit~: in novissimo dierum\\ erit mons domus Domini pr\ae paratus in vertice montium,\\ et sublimis super colles~:\\ et fluent ad eum populi,\\
...
\begin{flushleft}\begin{verse}${}^{6}$~In die illa, dicit Dominus,\\ congregabo claudicantem,\\ et eam quam ejeceram colligam,\\ et quam afflixeram~:\\
...
\Needspace{2.5\baselineskip}\versal{5}\begin{flushleft}\begin{verse}\vspace{-19pt}Nunc vastaberis, filia latronis.\\ Obsidionem posuerunt super nos~:\\ in virga percutient maxillam judicis Isra\"el.\end{verse}\end{flushleft}
...
\Needspace{2.5\baselineskip}\versal{6}\begin{flushleft}\begin{verse}\vspace{-19pt}Audite qu\ae\ Dominus loquitur~:\\ Surge, contende judicio adversum montes,\\ et audiant colles vocem tuam.\\
...
\Needspace{2.5\baselineskip}\versal{7}\begin{flushleft}\begin{verse}\vspace{-19pt}V\ae\ mihi, quia factus sum sicut qui colligit in autumno racemos vindemi\ae~!\\ non est botrus ad comedendum,\\ pr\ae coquas ficus desideravit anima mea.\\
...
\begin{flushleft}\begin{verse}${}^{7}$~Ego autem ad Dominum aspiciam~;\\ exspectabo Deum, salvatorem meum~:\\ audiet me Deus meus.\\
...
\begin{flushleft}\begin{verse}${}^{14}$~Pasce populum tuum in virga tua,\\ gregem h\ae reditatis tu\ae , habitantes solos, in saltu, in medio Carmeli.\\ Pascentur Basan et Galaad juxta dies antiquos.\\
