...
\Needspace{2.5\baselineskip}\versal{1}~Paulus et Timotheus, servi Jesu Christi, omnibus sanctis in Christo Jesu, qui sunt Philippis, cum episcopis et diaconibus.
...
\Needspace{2.5\baselineskip}\versal{2}~Si qua ergo consolatio in Christo, si quod solatium caritatis, si qua societas spiritus, si qua viscera miserationis~:
...
\Needspace{2.5\baselineskip}\versal{3}~De cetero, fratres mei, gaudete in Domino. Eadem vobis scribere, mihi quidem non pigrum, vobis autem necessarium.
...
\Needspace{2.5\baselineskip}\versal{4}~Itaque fratres mei carissimi, et desideratissimi, gaudium meum, et corona mea~: sic state in Domino, carissimi.
