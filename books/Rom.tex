...
\fancyhead[C]{\textsc{ad Romanos}}

\Needspace{2.5\baselineskip}\versal{1}~Paulus, servus Jesu Christi, vocatus Apostolus, segregatus in Evangelium Dei,
...
\Needspace{2.5\baselineskip}\versal{2}~Propter quod inexcusabilis es, o homo omnis qui judicas. In quo enim judicas alterum, teipsum condemnas~: eadem enim agis qu\ae\ judicas.
...
\Needspace{2.5\baselineskip}\versal{3}~Quid ergo amplius Jud\ae o est~? aut qu\ae\ utilitas circumcisionis~?
...
\Needspace{2.5\baselineskip}\versal{4}~Quid ergo dicemus invenisse Abraham patrem nostrum secundum carnem~?
...
\Needspace{2.5\baselineskip}\versal{5}~Justificati ergo ex fide, pacem habeamus ad Deum per Dominum nostrum Jesum Christum~:
...
\Needspace{2.5\baselineskip}\versal{6}~Quid ergo dicemus~? permanebimus in peccato ut gratia abundet~?
...
\Needspace{2.5\baselineskip}\versal{7}~An ignoratis, fratres (scientibus enim legem loquor), quia lex in homine dominatur quanto tempore vivit~?
...
\Needspace{2.5\baselineskip}\versal{8}~Nihil ergo nunc damnationis est iis qui sunt in Christo Jesu~: qui non secundum carnem ambulant.
...
\Needspace{2.5\baselineskip}\versal{9}~Veritatem dico in Christo, non mentior~: testimonium mihi perhibente conscientia mea in Spiritu Sancto~:
...
\Needspace{2.5\baselineskip}\versal{10}~Fratres, voluntas quidem cordis mei, et obsecratio ad Deum, fit pro illis in salutem.
...
\Needspace{2.5\baselineskip}\versal{11}~Dico ergo~: Numquid Deus repulit populum suum~? Absit. Nam et ego Isra\"elita sum ex semine Abraham, de tribu Benjamin~:
...
\Needspace{2.5\baselineskip}\versal{12}~Obsecro itaque vos fratres per misericordiam Dei, ut exhibeatis corpora vestra hostiam viventem, sanctam, Deo placentem, rationabile obsequium vestrum.
...
\Needspace{2.5\baselineskip}\versal{13}~Omnis anima potestatibus sublimioribus subdita sit~: non est enim potestas nisi a Deo~: qu\ae\ autem sunt, a Deo ordinat\ae\ sunt.
...
\Needspace{2.5\baselineskip}\versal{14}~Infirmum autem in fide assumite, non in disceptationibus cogitationum.
...
\Needspace{2.5\baselineskip}\versal{15}~Debemus autem nos firmiores imbecillitates infirmorum sustinere, et non nobis placere.
...
\Needspace{2.5\baselineskip}\versal{16}~Commendo autem vobis Phœben sororem nostram, qu\ae\ est in ministerio ecclesi\ae , qu\ae\ est in Cenchris~:
