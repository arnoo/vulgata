...
\bchapter[Psalm]
\begin{flushleft}\begin{verse}\mylettrine{B}eatus vir qui non abiit in consilio impiorum,\\ et in via peccatorum non stetit,\\ et in cathedra pestilenti\ae\ non sedit~;\\
...
\bchapter[Psalm]
\begin{flushleft}\begin{verse}\mylettrine{Q}uare fremuerunt gentes,\\ et populi meditati sunt inania~?\\
...
\bchapter[Psalm]
\mylettrine{P}salmus David, cum fugeret a facie Absalom filii sui.
\begin{flushleft}\begin{verse}${}^{2}$~Domine, quid multiplicati sunt qui tribulant me~?\\ Multi insurgunt adversum me~;\\
...
\bchapter[Psalm]
\mylettrine{I}n finem, in carminibus. Psalmus David.
\begin{flushleft}\begin{verse}${}^{2}$~Cum invocarem exaudivit me Deus justiti\ae\ me\ae ,\\ in tribulatione dilatasti mihi.\\ Miserere mei, et exaudi orationem meam.\\
...
\bchapter[Psalm]
\mylettrine{I}n finem, pro ea qu\ae\ h\ae reditatem consequitur. Psalmus David.
\begin{flushleft}\begin{verse}${}^{2}$~Verba mea auribus percipe, Domine~;\\ intellige clamorem meum.\\
...
\bchapter[Psalm]
\mylettrine{I}n finem, in carminibus. Psalmus David. Pro octava.
\begin{flushleft}\begin{verse}${}^{2}$~Domine, ne in furore tuo arguas me,\\ neque in ira tua corripias me.\\
...
\bchapter[Psalm]
\mylettrine{P}salmus David, quem cantavit Domino pro verbis Chusi, filii Jemini.
\begin{flushleft}\begin{verse}${}^{2}$~Domine Deus meus, in te speravi~;\\ salvum me fac ex omnibus persequentibus me, et libera me~:\\
...
\bchapter[Psalm]
\mylettrine{I}n finem, pro torcularibus. Psalmus David.
\begin{flushleft}\begin{verse}${}^{2}$~Domine, Dominus noster,\\ quam admirabile est nomen tuum in universa terra~!\\ quoniam elevata est magnificentia tua super c\ae los.\\
...
\bchapter[Psalm]
\mylettrine{I}n finem, pro occultis filii. Psalmus David.
\begin{flushleft}\begin{verse}${}^{2}$~Confitebor tibi, Domine, in toto corde meo~;\\ narrabo omnia mirabilia tua.\\
...
\bchapter[Psalm]
\mylettrine{I}n finem. Psalmus David.
\begin{flushleft}\begin{verse}${}^{2}$~In Domino confido~; quomodo dicitis anim\ae\ me\ae~:\\ Transmigra in montem sicut passer~?\\
...
\bchapter[Psalm]
\mylettrine{I}n finem, pro octava. Psalmus David.
\begin{flushleft}\begin{verse}${}^{2}$~Salvum me fac, Domine, quoniam defecit sanctus,\\ quoniam diminut\ae\ sunt veritates a filiis hominum.\\
...
\bchapter[Psalm]
\mylettrine{I}n finem. Psalmus David. \begin{flushleft}\begin{verse}Usquequo, Domine, oblivisceris me in finem~?\\ usquequo avertis faciem tuam a me~?\\
...
\bchapter[Psalm]
\mylettrine{I}n finem. Psalmus David. \begin{flushleft}\begin{verse}Dixit insipiens in corde suo~: Non est Deus.\\ Corrupti sunt, et abominabiles facti sunt in studiis suis~;\\ non est qui faciat bonum, non est usque ad unum.\\
...
\bchapter[Psalm]
\mylettrine{P}salmus David. \begin{flushleft}\begin{verse}Domine, quis habitabit in tabernaculo tuo~?\\ aut quis requiescet in monte sancto tuo~?\\
...
\bchapter[Psalm]
\mylettrine{T}ituli inscriptio, ipsi David. \begin{flushleft}\begin{verse}Conserva me, Domine, quoniam speravi in te.\\
...
\bchapter[Psalm]
\mylettrine{O}ratio David. \begin{flushleft}\begin{verse}Exaudi, Domine, justitiam meam~;\\ intende deprecationem meam.\\ Auribus percipe orationem meam,\\ non in labiis dolosis.\\
...
\bchapter[Psalm]
\mylettrine{I}n finem. Puero Domini David, qui locutus est Domino verba cantici hujus, in die qua eripuit eum Dominus de manu omnium inimicorum ejus, et de manu Saul, et dixit~:
\begin{flushleft}\begin{verse}${}^{2}$~Diligam te, Domine, fortitudo mea.\\
...
\bchapter[Psalm]
\mylettrine{I}n finem. Psalmus David.
\begin{flushleft}\begin{verse}${}^{2}$~C\ae li enarrant gloriam Dei,\\ et opera manuum ejus annuntiat firmamentum.\\
...
\bchapter[Psalm]
\mylettrine{I}n finem. Psalmus David.
\begin{flushleft}\begin{verse}${}^{2}$~Exaudiat te Dominus in die tribulationis~;\\ protegat te nomen Dei Jacob.\\
...
\bchapter[Psalm]
\mylettrine{I}n finem. Psalmus David.
\begin{flushleft}\begin{verse}${}^{2}$~Domine, in virtute tua l\ae tabitur rex,\\ et super salutare tuum exsultabit vehementer.\\
...
\bchapter[Psalm]
\mylettrine{I}n finem, pro susceptione matutina. Psalmus David.
\begin{flushleft}\begin{verse}${}^{2}$~Deus, Deus meus, respice in me~: quare me dereliquisti~?\\ longe a salute mea verba delictorum meorum.\\
...
\bchapter[Psalm]
\mylettrine{P}salmus David. \begin{flushleft}\begin{verse}Dominus regit me, et nihil mihi deerit~:\\
...
\bchapter[Psalm]
\mylettrine{P}rima sabbati. Psalmus David. \begin{flushleft}\begin{verse}Domini est terra, et plenitudo ejus~;\\ orbis terrarum, et universi qui habitant in eo.\\
...
\bchapter[Psalm]
\mylettrine{I}n finem. Psalmus David. \begin{flushleft}\begin{verse}Ad te, Domine, levavi animam meam~:\\
...
\bchapter[Psalm]
\mylettrine{I}n finem. Psalmus David. \begin{flushleft}\begin{verse}Judica me, Domine, quoniam ego in innocentia mea ingressus sum,\\ et in Domino sperans non infirmabor.\\
...
\bchapter[Psalm]
\mylettrine{P}salmus David, priusquam liniretur. \begin{flushleft}\begin{verse}Dominus illuminatio mea et salus mea~: quem timebo~?\\ Dominus protector vit\ae\ me\ae~:\\ a quo trepidabo~?\\
...
\bchapter[Psalm]
\mylettrine{P}salmus ipsi David. \begin{flushleft}\begin{verse}Ad te, Domine, clamabo~; Deus meus, ne sileas a me~:\\ nequando taceas a me, et assimilabor descendentibus in lacum.\\
...
\bchapter[Psalm]
\mylettrine{P}salmus David, in consummatione tabernaculi. \begin{flushleft}\begin{verse}Afferte Domino, filii Dei,\\ afferte Domino filios arietum.\\
...
\bchapter[Psalm]
\mylettrine{P}salmus cantici, in dedicatione domus David.
\begin{flushleft}\begin{verse}${}^{2}$~Exaltabo te, Domine, quoniam suscepisti me,\\ nec delectasti inimicos meos super me.\\
...
\bchapter[Psalm]
\mylettrine{I}n finem. Psalmus David, pro extasi.
\begin{flushleft}\begin{verse}${}^{2}$~In te, Domine, speravi~;\\ non confundar in \ae ternum~:\\ in justitia tua libera me.\\
...
\bchapter[Psalm]
\mylettrine{I}psi David intellectus. \begin{flushleft}\begin{verse}Beati quorum remiss\ae\ sunt iniquitates,\\ et quorum tecta sunt peccata.\\
...
\bchapter[Psalm]
\mylettrine{P}salmus David. \begin{flushleft}\begin{verse}Exsultate, justi, in Domino~;\\ rectos decet collaudatio.\\
...
\bchapter[Psalm]
\mylettrine{D}avidi, cum immutavit vultum suum coram Achimelech, et dimisit eum, et abiit.
\begin{flushleft}\begin{verse}${}^{2}$~Benedicam Dominum in omni tempore~;\\ semper laus ejus in ore meo.\\
...
\bchapter[Psalm]
\mylettrine{I}psi David. \begin{flushleft}\begin{verse}Judica, Domine, nocentes me~;\\ expugna impugnantes me.\\
...
\bchapter[Psalm]
\mylettrine{I}n finem. Servo Domini ipsi David.
\begin{flushleft}\begin{verse}${}^{2}$~Dixit injustus ut delinquat in semetipso~:\\ non est timor Dei ante oculos ejus.\\
...
\bchapter[Psalm]
\mylettrine{P}salmus ipsi David. \begin{flushleft}\begin{verse}Noli \ae mulari in malignantibus,\\ neque zelaveris facientes iniquitatem~:\\
...
\bchapter[Psalm]
\mylettrine{P}salmus David, in rememorationem de sabbato.
\begin{flushleft}\begin{verse}${}^{2}$~Domine, ne in furore tuo arguas me,\\ neque in ira tua corripias me~:\\
...
\bchapter[Psalm]
\mylettrine{I}n finem, ipsi Idithun. Canticum David.
\begin{flushleft}\begin{verse}${}^{2}$~Dixi~: Custodiam vias meas~:\\ ut non delinquam in lingua mea.\\ Posui ori meo custodiam,\\ cum consisteret peccator adversum me.\\
...
\bchapter[Psalm]
\mylettrine{I}n finem. Psalmus ipsi David.
\begin{flushleft}\begin{verse}${}^{2}$~Exspectans exspectavi Dominum,\\ et intendit mihi.\\
...
\bchapter[Psalm]
\mylettrine{I}n finem. Psalmus ipsi David.
\begin{flushleft}\begin{verse}${}^{2}$~Beatus qui intelligit super egenum et pauperem~:\\ in die mala liberabit eum Dominus.\\
...
\bchapter[Psalm]
\mylettrine{I}n finem. Intellectus filiis Core.
\begin{flushleft}\begin{verse}${}^{2}$~Quemadmodum desiderat cervus ad fontes aquarum,\\ ita desiderat anima mea ad te, Deus.\\
...
\bchapter[Psalm]
\mylettrine{P}salmus David. \begin{flushleft}\begin{verse}Judica me, Deus, et discerne causam meam de gente non sancta~:\\ ab homine iniquo et doloso erue me.\\
...
\bchapter[Psalm]
\mylettrine{I}n finem. Filiis Core ad intellectum.
\begin{flushleft}\begin{verse}${}^{2}$~Deus, auribus nostris audivimus,\\ patres nostri annuntiaverunt nobis,\\ opus quod operatus es in diebus eorum,\\ et in diebus antiquis.\\
...
\bchapter[Psalm]
\mylettrine{I}n finem, pro iis qui commutabuntur. Filiis Core, ad intellectum. Canticum pro dilecto.
\begin{flushleft}\begin{verse}${}^{2}$~Eructavit cor meum verbum bonum~:\\ dico ego opera mea regi.\\ Lingua mea calamus scrib\ae \\ velociter scribentis.\\
...
\bchapter[Psalm]
\mylettrine{I}n finem, filiis Core, pro arcanis. Psalmus.
\begin{flushleft}\begin{verse}${}^{2}$~Deus noster refugium et virtus~;\\ adjutor in tribulationibus qu\ae\ invenerunt nos nimis.\\
...
\bchapter[Psalm]
\mylettrine{I}n finem, pro filiis Core. Psalmus.
\begin{flushleft}\begin{verse}${}^{2}$~Omnes gentes, plaudite manibus~;\\ jubilate Deo in voce exsultationis~:\\
...
\bchapter[Psalm]
\mylettrine{P}salmus cantici. Filiis Core, secunda sabbati.
\begin{flushleft}\begin{verse}${}^{2}$~Magnus Dominus et laudabilis nimis,\\ in civitate Dei nostri, in monte sancto ejus.\\
...
\bchapter[Psalm]
\mylettrine{I}n finem, filiis Core. Psalmus.
\begin{flushleft}\begin{verse}${}^{2}$~Audite h\ae c, omnes gentes~;\\ auribus percipite, omnes qui habitatis orbem~:\\
...
\bchapter[Psalm]
\mylettrine{P}salmus Asaph. \begin{flushleft}\begin{verse}Deus deorum Dominus locutus est,\\ et vocavit terram a solis ortu usque ad occasum.\\
...
\bchapter[Psalm]
\mylettrine{I}n finem. Intellectus David,
...
\bchapter[Psalm]
\mylettrine{I}n finem, pro Ma\"eleth intelligenti\ae\ David. \begin{flushleft}\begin{verse}Dixit insipiens in corde suo~: Non est Deus.\\
...
\bchapter[Psalm]
\mylettrine{I}n finem, in carminibus. Intellectus David,
...
\bchapter[Psalm]
\mylettrine{I}n finem, in carminibus. Intellectus David.
\begin{flushleft}\begin{verse}${}^{2}$~Exaudi, Deus, orationem meam,\\ et ne despexeris deprecationem meam~:\\
...
\bchapter[Psalm]
\mylettrine{I}n finem, pro populo qui a sanctis longe factus est. David in tituli inscriptionem, cum tenuerunt eum Allophyli in Geth.
\begin{flushleft}\begin{verse}${}^{2}$~Miserere mei, Deus, quoniam conculcavit me homo~;\\ tota die impugnans, tribulavit me.\\
...
\bchapter[Psalm]
\mylettrine{I}n finem, ne disperdas. David in tituli inscriptionem, cum fugeret a facie Saul in speluncam.
\begin{flushleft}\begin{verse}${}^{2}$~Miserere mei, Deus, miserere mei,\\ quoniam in te confidit anima mea.\\ Et in umbra alarum tuarum sperabo,\\ donec transeat iniquitas.\\
...
\bchapter[Psalm]
\mylettrine{I}n finem, ne disperdas. David in tituli inscriptionem.
\begin{flushleft}\begin{verse}${}^{2}$~Si vere utique justitiam loquimini,\\ recta judicate, filii hominum.\\
...
\bchapter[Psalm]
\mylettrine{I}n finem, ne disperdas. David in tituli inscriptionem, quando misit Saul et custodivit domum ejus ut eum interficeret.
\begin{flushleft}\begin{verse}${}^{2}$~Eripe me de inimicis meis, Deus meus,\\ et ab insurgentibus in me libera me.\\
...
\bchapter[Psalm]
\mylettrine{I}n finem, pro his qui immutabuntur, in tituli inscriptionem ipsi David, in doctrinam,
...
\bchapter[Psalm]
\mylettrine{I}n finem. In hymnis David.
\begin{flushleft}\begin{verse}${}^{2}$~Exaudi, Deus, deprecationem meam~;\\ intende orationi me\ae .\\
...
\bchapter[Psalm]
\mylettrine{I}n finem, pro Idithun. Psalmus David.
\begin{flushleft}\begin{verse}${}^{2}$~Nonne Deo subjecta erit anima mea~?\\ ab ipso enim salutare meum.\\
...
\bchapter[Psalm]
\mylettrine{P}salmus David, cum esset in deserto Idum\ae \ae .
\begin{flushleft}\begin{verse}${}^{2}$~Deus, Deus meus, ad te de luce vigilo.\\ Sitivit in te anima mea~; quam multipliciter tibi caro mea~!\\
...
\bchapter[Psalm]
\mylettrine{I}n finem. Psalmus David.
\begin{flushleft}\begin{verse}${}^{2}$~Exaudi, Deus, orationem meam cum deprecor~;\\ a timore inimici eripe animam meam.\\
...
\bchapter[Psalm]
\mylettrine{I}n finem. Psalmus David, canticum Jeremi\ae\ et Ezechielis populo transmigrationis, cum inciperent exire.
\begin{flushleft}\begin{verse}${}^{2}$~Te decet hymnus, Deus, in Sion,\\ et tibi reddetur votum in Jerusalem.\\
...
\bchapter[Psalm]
\mylettrine{I}n finem. Canticum psalmi resurrectionis. \begin{flushleft}\begin{verse}Jubilate Deo, omnis terra~;\\
...
\bchapter[Psalm]
\mylettrine{I}n finem, in hymnis. Psalmus cantici David.
\begin{flushleft}\begin{verse}${}^{2}$~Deus misereatur nostri, et benedicat nobis~;\\ illuminet vultum suum super nos, et misereatur nostri~:\\
...
\bchapter[Psalm]
\mylettrine{I}n finem. Psalmus cantici ipsi David.
\begin{flushleft}\begin{verse}${}^{2}$~Exsurgat Deus, et dissipentur inimici ejus~;\\ et fugiant qui oderunt eum a facie ejus.\\
...
\bchapter[Psalm]
\mylettrine{I}n finem, pro iis qui commutabuntur. David.
\begin{flushleft}\begin{verse}${}^{2}$~Salvum me fac, Deus,\\ quoniam intraverunt aqu\ae\ usque ad animam meam.\\
...
\bchapter[Psalm]
\mylettrine{I}n finem. Psalmus David in rememorationem, quod salvum fecerit eum Dominus.
\begin{flushleft}\begin{verse}${}^{2}$~Deus, in adjutorium meum intende~;\\ Domine, ad adjuvandum me festina.\\
...
\bchapter[Psalm]
\mylettrine{P}salmus David, filiorum Jonadab, et priorum captivorum. \begin{flushleft}\begin{verse}In te, Domine, speravi~; non confundar in \ae ternum.\\
...
\bchapter[Psalm]
\mylettrine{P}salmus, in Salomonem.
\begin{flushleft}\begin{verse}${}^{2}$~Deus, judicium tuum regi da,\\ et justitiam tuam filio regis~;\\ judicare populum tuum in justitia,\\ et pauperes tuos in judicio.\\
...
\bchapter[Psalm]
\mylettrine{P}salmus Asaph. \begin{flushleft}\begin{verse}Quam bonus Isra\"el Deus,\\ his qui recto sunt corde~!\\
...
\bchapter[Psalm]
\mylettrine{I}ntellectus Asaph. \begin{flushleft}\begin{verse}Ut quid, Deus, repulisti in finem,\\ iratus est furor tuus super oves pascu\ae\ tu\ae~?\\
...
\bchapter[Psalm]
\mylettrine{I}n finem, ne corrumpas. Psalmus cantici Asaph.
\begin{flushleft}\begin{verse}${}^{2}$~Confitebimur tibi, Deus, confitebimur,\\ et invocabimus nomen tuum~;\\ narrabimus mirabilia tua.\\
...
\bchapter[Psalm]
\mylettrine{I}n finem, in laudibus. Psalmus Asaph, canticum ad Assyrios.
\begin{flushleft}\begin{verse}${}^{2}$~Notus in Jud\ae a Deus~;\\ in Isra\"el magnum nomen ejus.\\
...
\bchapter[Psalm]
\mylettrine{I}n finem, pro Idithun. Psalmus Asaph.
\begin{flushleft}\begin{verse}${}^{2}$~Voce mea ad Dominum clamavi~;\\ voce mea ad Deum, et intendit mihi.\\
...
\bchapter[Psalm]
\mylettrine{I}ntellectus Asaph. \begin{flushleft}\begin{verse}Attendite, popule meus, legem meam~;\\ inclinate aurem vestram in verba oris mei.\\
...
\bchapter[Psalm]
\mylettrine{P}salmus Asaph. \begin{flushleft}\begin{verse}Deus, venerunt gentes in h\ae reditatem tuam~;\\ polluerunt templum sanctum tuum~;\\ posuerunt Jerusalem in pomorum custodiam.\\
...
\bchapter[Psalm]
\mylettrine{I}n finem, pro iis qui commutabuntur. Testimonium Asaph, psalmus.
\begin{flushleft}\begin{verse}${}^{2}$~Qui regis Isra\"el, intende~;\\ qui deducis velut ovem Joseph.\\ Qui sedes super cherubim, manifestare\\
...
\bchapter[Psalm]
\mylettrine{I}n finem, pro torcularibus. Psalmus ipsi Asaph.
\begin{flushleft}\begin{verse}${}^{2}$~Exsultate Deo adjutori nostro~;\\ jubilate Deo Jacob.\\
...
\bchapter[Psalm]
\mylettrine{P}salmus Asaph. \begin{flushleft}\begin{verse}Deus stetit in synagoga deorum~;\\ in medio autem deos dijudicat.\\
...
\bchapter[Psalm]
\mylettrine{C}anticum Psalmi Asaph.
\begin{flushleft}\begin{verse}${}^{2}$~Deus, quis similis erit tibi~?\\ ne taceas, neque compescaris, Deus~:\\
...
\bchapter[Psalm]
\mylettrine{I}n finem, pro torcularibus filiis Core. Psalmus.
\begin{flushleft}\begin{verse}${}^{2}$~Quam dilecta tabernacula tua, Domine virtutum~!\\
...
\bchapter[Psalm]
\mylettrine{I}n finem, filiis Core. Psalmus.
\begin{flushleft}\begin{verse}${}^{2}$~Benedixisti, Domine, terram tuam~;\\ avertisti captivitatem Jacob.\\
...
\bchapter[Psalm]
\mylettrine{O}ratio ipsi David. \begin{flushleft}\begin{verse}Inclina, Domine, aurem tuam et exaudi me,\\ quoniam inops et pauper sum ego.\\
...
\bchapter[Psalm]
\mylettrine{F}iliis Core. Psalmus cantici. \begin{flushleft}\begin{verse}Fundamenta ejus in montibus sanctis~;\\
...
\bchapter[Psalm]
\mylettrine{C}anticum Psalmi, filiis Core, in finem, pro Maheleth ad respondendum. Intellectus Eman Ezrahit\ae .
\begin{flushleft}\begin{verse}${}^{2}$~Domine, Deus salutis me\ae ,\\ in die clamavi et nocte coram te.\\
...
\bchapter[Psalm]
\mylettrine{I}ntellectus Ethan Ezrahit\ae .
\begin{flushleft}\begin{verse}${}^{2}$~Misericordias Domini in \ae ternum cantabo~;\\ in generationem et generationem annuntiabo veritatem tuam in ore meo.\\
...
\bchapter[Psalm]
\mylettrine{O}ratio Moysi, hominis Dei. \begin{flushleft}\begin{verse}Domine, refugium factus es nobis\\ a generatione in generationem.\\
...
\bchapter[Psalm]
\mylettrine{L}aus cantici David. \begin{flushleft}\begin{verse}Qui habitat in adjutorio Altissimi,\\ in protectione Dei c\ae li commorabitur.\\
...
\bchapter[Psalm]
\mylettrine{P}salmus cantici, in die sabbati.
\begin{flushleft}\begin{verse}${}^{2}$~Bonum est confiteri Domino,\\ et psallere nomini tuo, Altissime~:\\
...
\bchapter[Psalm]
\mylettrine{L}aus cantici ipsi David, in die ante sabbatum, quando fundata est terra. \begin{flushleft}\begin{verse}Dominus regnavit, decorem indutus est~:\\ indutus est Dominus fortitudinem, et pr\ae cinxit se.\\ Etenim firmavit orbem terr\ae , qui non commovebitur.\\
...
\bchapter[Psalm]
\mylettrine{P}salmus ipsi David, quarta sabbati. \begin{flushleft}\begin{verse}Deus ultionum Dominus~;\\ Deus ultionum libere egit.\\
...
\bchapter[Psalm]
\mylettrine{L}aus cantici ipsi David. \begin{flushleft}\begin{verse}Venite, exsultemus Domino~;\\ jubilemus Deo salutari nostro~;\\
...
\bchapter[Psalm]
\mylettrine{C}anticum ipsi David, quando domus \ae dificabatur post captivitatem. \begin{flushleft}\begin{verse}Cantate Domino canticum novum~;\\ cantate Domino omnis terra.\\
...
\bchapter[Psalm]
\mylettrine{H}uic David, quando terra ejus restituta est. \begin{flushleft}\begin{verse}Dominus regnavit~: exsultet terra~;\\ l\ae tentur insul\ae\ mult\ae .\\
...
\bchapter[Psalm]
\mylettrine{P}salmus ipsi David. \begin{flushleft}\begin{verse}Cantate Domino canticum novum,\\ quia mirabilia fecit.\\ Salvavit sibi dextera ejus,\\ et brachium sanctum ejus.\\
...
\bchapter[Psalm]
\mylettrine{P}salmus ipsi David. \begin{flushleft}\begin{verse}Dominus regnavit~: irascantur populi~;\\ qui sedet super cherubim~: moveatur terra.\\
...
\bchapter[Psalm]
\mylettrine{P}salmus in confessione.
\begin{flushleft}\begin{verse}${}^{2}$~Jubilate Deo, omnis terra~;\\ servite Domino in l\ae titia.\\ Introite in conspectu ejus in exsultatione.\\
...
\bchapter[Psalm]
\mylettrine{P}salmus ipsi David. \begin{flushleft}\begin{verse}Misericordiam et judicium cantabo tibi, Domine~;\\ psallam,
...
\bchapter[Psalm]
\mylettrine{O}ratio pauperis, cum anxius fuerit, et in conspectu Domini effuderit precem suam.
\begin{flushleft}\begin{verse}${}^{2}$~Domine, exaudi orationem meam,\\ et clamor meus ad te veniat.\\
...
\bchapter[Psalm]
\mylettrine{I}psi David. \begin{flushleft}\begin{verse}Benedic, anima mea, Domino,\\ et omnia qu\ae\ intra me sunt nomini sancto ejus.\\
...
\bchapter[Psalm]
\mylettrine{I}psi David. \begin{flushleft}\begin{verse}Benedic, anima mea, Domino~:\\ Domine Deus meus, magnificatus es vehementer.\\ Confessionem et decorem induisti,\\
...
\bchapter[Psalm]
\mylettrine{A}lleluja. \begin{flushleft}\begin{verse}Confitemini Domino, et invocate nomen ejus~;\\ annuntiate inter gentes opera ejus.\\
...
\bchapter[Psalm]
\mylettrine{A}lleluja. \begin{flushleft}\begin{verse}Confitemini Domino, quoniam bonus,\\ quoniam in s\ae culum misericordia ejus.\\
...
\bchapter[Psalm]
\mylettrine{C}anticum Psalmi, ipsi David.
\begin{flushleft}\begin{verse}${}^{2}$~Paratum cor meum, Deus, paratum cor meum~;\\ cantabo, et psallam in gloria mea.\\
...
\bchapter[Psalm]
\mylettrine{I}n finem. Psalmus David.
\begin{flushleft}\begin{verse}${}^{2}$~Deus, laudem meam ne tacueris,\\ quia os peccatoris et os dolosi super me apertum est.\\
...
\bchapter[Psalm]
\mylettrine{P}salmus David. \begin{flushleft}\begin{verse}Dixit Dominus Domino meo~:\\ Sede a dextris meis,\\ donec ponam inimicos tuos scabellum pedum tuorum.\\
...
\bchapter[Psalm]
\mylettrine{A}lleluja. \begin{flushleft}\begin{verse}Confitebor tibi, Domine, in toto corde meo,\\ in consilio justorum, et congregatione.\\
...
\bchapter[Psalm]
\mylettrine{A}lleluja, reversionis Agg\ae i et Zachari\ae . \begin{flushleft}\begin{verse}Beatus vir qui timet Dominum~:\\ in mandatis ejus volet nimis.\\
...
\bchapter[Psalm]
\mylettrine{A}lleluja. \begin{flushleft}\begin{verse}Laudate, pueri, Dominum~;\\ laudate nomen Domini.\\
...
\bchapter[Psalm]
\mylettrine{A}lleluja. \begin{flushleft}\begin{verse}In exitu Isra\"el de \AE gypto,\\ domus Jacob de populo barbaro,\\
...
\bchapter[Psalm]
\mylettrine{A}lleluja. \begin{flushleft}\begin{verse}Dilexi, quoniam exaudiet Dominus\\ vocem orationis me\ae .\\
...
\bchapter[Psalm]
\mylettrine{A}lleluja. \begin{flushleft}\begin{verse}Credidi, propter quod locutus sum~;\\ ego autem humiliatus sum nimis.\\
...
\bchapter[Psalm]
\mylettrine{A}lleluja. \begin{flushleft}\begin{verse}Laudate Dominum, omnes gentes~;\\ laudate eum, omnes populi.\\
...
\bchapter[Psalm]
\mylettrine{A}lleluja. \begin{flushleft}\begin{verse}\textsc{Aleph.} Beati immaculati in via,\\ qui ambulant in lege Domini.\\
...
\bchapter[Psalm]
\mylettrine{C}anticum graduum. \begin{flushleft}\begin{verse}Ad Dominum cum tribularer clamavi,\\ et exaudivit me.\\
...
\bchapter[Psalm]
\mylettrine{C}anticum graduum. \begin{flushleft}\begin{verse}Levavi oculos meos in montes,\\ unde veniet auxilium mihi.\\
...
\bchapter[Psalm]
\mylettrine{C}anticum graduum. \begin{flushleft}\begin{verse}L\ae tatus sum in his qu\ae\ dicta sunt mihi~:\\ In domum Domini ibimus.\\
...
\bchapter[Psalm]
\mylettrine{C}anticum graduum. \begin{flushleft}\begin{verse}Ad te levavi oculos meos,\\ qui habitas in c\ae lis.\\
...
\bchapter[Psalm]
\mylettrine{C}anticum graduum. \begin{flushleft}\begin{verse}Nisi quia Dominus erat in nobis,\\ dicat nunc Isra\"el,\\
...
\bchapter[Psalm]
\mylettrine{C}anticum graduum. \begin{flushleft}\begin{verse}Qui confidunt in Domino, sicut mons Sion~:\\ non commovebitur in \ae ternum,\\ qui habitat
...
\bchapter[Psalm]
\mylettrine{C}anticum graduum. \begin{flushleft}\begin{verse}In convertendo Dominus captivitatem Sion,\\ facti sumus sicut consolati.\\
...
\bchapter[Psalm]
\mylettrine{C}anticum graduum Salomonis. \begin{flushleft}\begin{verse}Nisi Dominus \ae dificaverit domum,\\ in vanum laboraverunt qui \ae dificant eam.\\ Nisi Dominus custodierit civitatem,\\ frustra vigilat qui custodit eam.\\
...
\bchapter[Psalm]
\mylettrine{C}anticum graduum. \begin{flushleft}\begin{verse}Beati omnes qui timent Dominum,\\ qui ambulant in viis ejus.\\
...
\bchapter[Psalm]
\mylettrine{C}anticum graduum. \begin{flushleft}\begin{verse}S\ae pe expugnaverunt me a juventute mea,\\ dicat nunc Isra\"el~;\\
...
\bchapter[Psalm]
\mylettrine{C}anticum graduum. \begin{flushleft}\begin{verse}De profundis clamavi ad te, Domine~;\\
...
\bchapter[Psalm]
\mylettrine{C}anticum graduum David. \begin{flushleft}\begin{verse}Domine, non est exaltatum cor meum,\\ neque elati sunt oculi mei,\\ neque ambulavi in magnis,\\ neque in mirabilibus super me.\\
...
\bchapter[Psalm]
\mylettrine{C}anticum graduum. \begin{flushleft}\begin{verse}Memento, Domine, David,\\ et omnis mansuetudinis ejus~:\\
...
\bchapter[Psalm]
\mylettrine{C}anticum graduum David. \begin{flushleft}\begin{verse}Ecce quam bonum et quam jucundum,\\ habitare fratres in unum~!\\
...
\bchapter[Psalm]
\mylettrine{C}anticum graduum. \begin{flushleft}\begin{verse}Ecce nunc benedicite Dominum, omnes servi Domini~:\\ qui statis in domo Domini,\\ in atriis domus Dei nostri.\\
...
\bchapter[Psalm]
\mylettrine{A}lleluja. \begin{flushleft}\begin{verse}Laudate nomen Domini~;\\ laudate, servi, Dominum~:\\
...
\bchapter[Psalm]
\mylettrine{A}lleluja. \begin{flushleft}\begin{verse}Confitemini Domino, quoniam bonus,\\ quoniam in \ae ternum misericordia ejus.\\
...
\bchapter[Psalm]
\mylettrine{P}salmus David, Jeremi\ae . \begin{flushleft}\begin{verse}Super flumina Babylonis illic sedimus et flevimus,\\ cum recordaremur Sion.\\
...
\bchapter[Psalm]
\mylettrine{I}psi David. \begin{flushleft}\begin{verse}Confitebor tibi, Domine, in toto corde meo,\\ quoniam audisti verba oris mei.\\ In conspectu angelorum psallam tibi~;\\
...
\bchapter[Psalm]
\mylettrine{I}n finem, psalmus David. \begin{flushleft}\begin{verse}Domine, probasti me, et cognovisti me~;\\
...
\bchapter[Psalm]
\mylettrine{I}n finem. Psalmus David.
\begin{flushleft}\begin{verse}${}^{2}$~Eripe me, Domine, ab homine malo~;\\ a viro iniquo eripe me.\\
...
\bchapter[Psalm]
\mylettrine{P}salmus David. \begin{flushleft}\begin{verse}Domine, clamavi ad te~: exaudi me~;\\ intende voci me\ae , cum clamavero ad te.\\
...
\bchapter[Psalm]
\mylettrine{I}ntellectus David, cum esset in spelunca, oratio.
\begin{flushleft}\begin{verse}${}^{2}$~Voce mea ad Dominum clamavi,\\ voce mea ad Dominum deprecatus sum.\\
...
\bchapter[Psalm]
\mylettrine{P}salmus David, quando persequebatur eum Absalom filius ejus. \begin{flushleft}\begin{verse}Domine, exaudi orationem meam~;\\ auribus percipe obsecrationem meam in veritate tua~;\\ exaudi me in tua justitia.\\
...
\bchapter[Psalm]
\mylettrine{P}salmus David. Adversus Goliath. \begin{flushleft}\begin{verse}Benedictus Dominus Deus meus,\\ qui docet manus meas ad pr\ae lium,\\ et digitos meos ad bellum.\\
...
\bchapter[Psalm]
\mylettrine{L}audatio ipsi David. \begin{flushleft}\begin{verse}Exaltabo te, Deus meus rex,\\ et benedicam nomini tuo in s\ae culum, et in s\ae culum s\ae culi.\\
...
\bchapter[Psalm]
\mylettrine{A}lleluja, Agg\ae i et Zachari\ae .
\begin{flushleft}\begin{verse}${}^{2}$~Lauda, anima mea, Dominum.\\ Laudabo Dominum in vita mea~;\\ psallam Deo meo quamdiu fuero.\\ Nolite confidere in principibus,\\
...
\bchapter[Psalm]
\mylettrine{A}lleluja. \begin{flushleft}\begin{verse}Laudate Dominum, quoniam bonus est psalmus~;\\ Deo nostro sit jucunda, decoraque laudatio.\\
...
\bchapter[Psalm]
\mylettrine{A}lleluja. \begin{flushleft}\begin{verse}Lauda, Jerusalem, Dominum~;\\ lauda Deum tuum, Sion.\\
...
\bchapter[Psalm]
\mylettrine{A}lleluja. \begin{flushleft}\begin{verse}Laudate Dominum de c\ae lis~;\\ laudate eum in excelsis.\\
...
\bchapter[Psalm]
\mylettrine{A}lleluja. \begin{flushleft}\begin{verse}Cantate Domino canticum novum~;\\ laus ejus in ecclesia sanctorum.\\
...
\bchapter[Psalm]
\mylettrine{A}lleluja. \begin{flushleft}\begin{verse}Laudate Dominum in sanctis ejus~;\\ laudate eum in firmamento virtutis ejus.\\
