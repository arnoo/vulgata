...
\Needspace{2.5\baselineskip}\versal{1}~Paulus, Apostolus non ab hominibus, neque per hominem, sed per Jesum Christum, et Deum Patrem, qui suscitavit eum a mortuis~:
...
\Needspace{2.5\baselineskip}\versal{2}~Deinde post annos quatuordecim, iterum ascendi Jerosolymam cum Barnaba, assumpto et Tito.
...
\Needspace{2.5\baselineskip}\versal{3}~O insensati Galat\ae , quis vos fascinavit non obedire veritati, ante quorum oculos Jesus Christus pr\ae scriptus est, in vobis crucifixus~?
...
\Needspace{2.5\baselineskip}\versal{4}~Dico autem~: quanto tempore h\ae res parvulus est, nihil differt a servo, cum sit dominus omnium~:
...
\Needspace{2.5\baselineskip}\versal{5}~State, et nolite iterum jugo servitutis contineri.
...
\Needspace{2.5\baselineskip}\versal{6}~Fratres, etsi pr\ae occupatus fuerit homo in aliquo delicto, vos, qui spirituales estis, hujusmodi instruite in spiritu lenitatis, considerans teipsum, ne et tu tenteris.
