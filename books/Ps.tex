...
\Needspace{2.5\baselineskip}\versal{3}~Psalmus David, cum fugeret a facie Absalom filii sui.
...
\Needspace{2.5\baselineskip}\versal{4}~In finem, in carminibus. Psalmus David.
...
\Needspace{2.5\baselineskip}\versal{5}~In finem, pro ea qu\ae\ h\ae reditatem consequitur. Psalmus David.
...
\Needspace{2.5\baselineskip}\versal{6}~In finem, in carminibus. Psalmus David. Pro octava.
...
\Needspace{2.5\baselineskip}\versal{7}~Psalmus David, quem cantavit Domino pro verbis Chusi, filii Jemini.
...
\Needspace{2.5\baselineskip}\versal{8}~In finem, pro torcularibus. Psalmus David.
...
\Needspace{2.5\baselineskip}\versal{9}~In finem, pro occultis filii. Psalmus David.
...
\Needspace{2.5\baselineskip}\versal{10}~In finem. Psalmus David.
...
\Needspace{2.5\baselineskip}\versal{11}~In finem, pro octava. Psalmus David.
...
\Needspace{2.5\baselineskip}\versal{12}~In finem. Psalmus David. \begin{flushleft}\begin{verse}\vspace{6pt}Usquequo, Domine, oblivisceris me in finem~?\\ usquequo avertis faciem tuam a me~?\\
...
\Needspace{2.5\baselineskip}\versal{13}~In finem. Psalmus David. \begin{flushleft}\begin{verse}\vspace{6pt}Dixit insipiens in corde suo~: Non est Deus.\\ Corrupti sunt, et abominabiles facti sunt in studiis suis~;\\ non est qui faciat bonum, non est usque ad unum.\\
...
\Needspace{2.5\baselineskip}\versal{14}~Psalmus David. \begin{flushleft}\begin{verse}\vspace{6pt}Domine, quis habitabit in tabernaculo tuo~?\\ aut quis requiescet in monte sancto tuo~?\\
...
\Needspace{2.5\baselineskip}\versal{15}~Tituli inscriptio, ipsi David. \begin{flushleft}\begin{verse}\vspace{6pt}Conserva me, Domine, quoniam speravi in te.\\
...
\Needspace{2.5\baselineskip}\versal{16}~Oratio David. \begin{flushleft}\begin{verse}\vspace{6pt}Exaudi, Domine, justitiam meam~;\\ intende deprecationem meam.\\ Auribus percipe orationem meam,\\ non in labiis dolosis.\\
...
\Needspace{2.5\baselineskip}\versal{17}~In finem. Puero Domini David, qui locutus est Domino verba cantici hujus, in die qua eripuit eum Dominus de manu omnium inimicorum ejus, et de manu Saul, et dixit~:
...
\Needspace{2.5\baselineskip}\versal{18}~In finem. Psalmus David.
...
\Needspace{2.5\baselineskip}\versal{19}~In finem. Psalmus David.
...
\Needspace{2.5\baselineskip}\versal{20}~In finem. Psalmus David.
...
\Needspace{2.5\baselineskip}\versal{21}~In finem, pro susceptione matutina. Psalmus David.
...
\Needspace{2.5\baselineskip}\versal{22}~Psalmus David. \begin{flushleft}\begin{verse}\vspace{6pt}Dominus regit me, et nihil mihi deerit~:\\
...
\Needspace{2.5\baselineskip}\versal{23}~Prima sabbati. Psalmus David. \begin{flushleft}\begin{verse}\vspace{6pt}Domini est terra, et plenitudo ejus~;\\ orbis terrarum, et universi qui habitant in eo.\\
...
\Needspace{2.5\baselineskip}\versal{24}~In finem. Psalmus David. \begin{flushleft}\begin{verse}\vspace{6pt}Ad te, Domine, levavi animam meam~:\\
...
\Needspace{2.5\baselineskip}\versal{25}~In finem. Psalmus David. \begin{flushleft}\begin{verse}\vspace{6pt}Judica me, Domine, quoniam ego in innocentia mea ingressus sum,\\ et in Domino sperans non infirmabor.\\
...
\Needspace{2.5\baselineskip}\versal{26}~Psalmus David, priusquam liniretur. \begin{flushleft}\begin{verse}\vspace{6pt}Dominus illuminatio mea et salus mea~: quem timebo~?\\ Dominus protector vit\ae\ me\ae~:\\ a quo trepidabo~?\\
...
\Needspace{2.5\baselineskip}\versal{27}~Psalmus ipsi David. \begin{flushleft}\begin{verse}\vspace{6pt}Ad te, Domine, clamabo~; Deus meus, ne sileas a me~:\\ nequando taceas a me, et assimilabor descendentibus in lacum.\\
...
\Needspace{2.5\baselineskip}\versal{28}~Psalmus David, in consummatione tabernaculi. \begin{flushleft}\begin{verse}\vspace{6pt}Afferte Domino, filii Dei,\\ afferte Domino filios arietum.\\
...
\Needspace{2.5\baselineskip}\versal{29}~Psalmus cantici, in dedicatione domus David.
...
\Needspace{2.5\baselineskip}\versal{30}~In finem. Psalmus David, pro extasi.
...
\Needspace{2.5\baselineskip}\versal{31}~Ipsi David intellectus. \begin{flushleft}\begin{verse}\vspace{6pt}Beati quorum remiss\ae\ sunt iniquitates,\\ et quorum tecta sunt peccata.\\
...
\Needspace{2.5\baselineskip}\versal{32}~Psalmus David. \begin{flushleft}\begin{verse}\vspace{6pt}Exsultate, justi, in Domino~;\\ rectos decet collaudatio.\\
...
\Needspace{2.5\baselineskip}\versal{33}~Davidi, cum immutavit vultum suum coram Achimelech, et dimisit eum, et abiit.
...
\Needspace{2.5\baselineskip}\versal{34}~Ipsi David. \begin{flushleft}\begin{verse}\vspace{6pt}Judica, Domine, nocentes me~;\\ expugna impugnantes me.\\
...
\Needspace{2.5\baselineskip}\versal{35}~In finem. Servo Domini ipsi David.
...
\Needspace{2.5\baselineskip}\versal{36}~Psalmus ipsi David. \begin{flushleft}\begin{verse}\vspace{6pt}Noli \ae mulari in malignantibus,\\ neque zelaveris facientes iniquitatem~:\\
...
\Needspace{2.5\baselineskip}\versal{37}~Psalmus David, in rememorationem de sabbato.
\begin{flushleft}\begin{verse}\vspace{6pt}${}^{2}$~Domine, ne in furore tuo arguas me,\\ neque in ira tua corripias me~:\\
...
\Needspace{2.5\baselineskip}\versal{38}~In finem, ipsi Idithun. Canticum David.
...
\Needspace{2.5\baselineskip}\versal{39}~In finem. Psalmus ipsi David.
...
\Needspace{2.5\baselineskip}\versal{40}~In finem. Psalmus ipsi David.
...
\Needspace{2.5\baselineskip}\versal{41}~In finem. Intellectus filiis Core.
...
\Needspace{2.5\baselineskip}\versal{42}~Psalmus David. \begin{flushleft}\begin{verse}\vspace{6pt}Judica me, Deus, et discerne causam meam de gente non sancta~:\\ ab homine iniquo et doloso erue me.\\
...
\Needspace{2.5\baselineskip}\versal{43}~In finem. Filiis Core ad intellectum.
...
\Needspace{2.5\baselineskip}\versal{44}~In finem, pro iis qui commutabuntur. Filiis Core, ad intellectum. Canticum pro dilecto.
...
\Needspace{2.5\baselineskip}\versal{45}~In finem, filiis Core, pro arcanis. Psalmus.
...
\Needspace{2.5\baselineskip}\versal{46}~In finem, pro filiis Core. Psalmus.
...
\Needspace{2.5\baselineskip}\versal{47}~Psalmus cantici. Filiis Core, secunda sabbati.
...
\Needspace{2.5\baselineskip}\versal{48}~In finem, filiis Core. Psalmus.
...
\Needspace{2.5\baselineskip}\versal{49}~Psalmus Asaph. \begin{flushleft}\begin{verse}\vspace{6pt}Deus deorum Dominus locutus est,\\ et vocavit terram a solis ortu usque ad occasum.\\
...
\Needspace{2.5\baselineskip}\versal{50}~In finem. Psalmus David,
...
\Needspace{2.5\baselineskip}\versal{51}~In finem. Intellectus David,
...
\Needspace{2.5\baselineskip}\versal{52}~In finem, pro Ma\"eleth intelligenti\ae\ David. \begin{flushleft}\begin{verse}\vspace{6pt}Dixit insipiens in corde suo~: Non est Deus.\\
...
\Needspace{2.5\baselineskip}\versal{53}~In finem, in carminibus. Intellectus David,
...
\Needspace{2.5\baselineskip}\versal{54}~In finem, in carminibus. Intellectus David.
...
\Needspace{2.5\baselineskip}\versal{55}~In finem, pro populo qui a sanctis longe factus est. David in tituli inscriptionem, cum tenuerunt eum Allophyli in Geth.
...
\Needspace{2.5\baselineskip}\versal{56}~In finem, ne disperdas. David in tituli inscriptionem, cum fugeret a facie Saul in speluncam.
...
\Needspace{2.5\baselineskip}\versal{57}~In finem, ne disperdas. David in tituli inscriptionem.
...
\Needspace{2.5\baselineskip}\versal{58}~In finem, ne disperdas. David in tituli inscriptionem, quando misit Saul et custodivit domum ejus ut eum interficeret.
...
\Needspace{2.5\baselineskip}\versal{59}~In finem, pro his qui immutabuntur, in tituli inscriptionem ipsi David, in doctrinam,
...
\Needspace{2.5\baselineskip}\versal{60}~In finem. In hymnis David.
...
\Needspace{2.5\baselineskip}\versal{61}~In finem, pro Idithun. Psalmus David.
...
\Needspace{2.5\baselineskip}\versal{62}~Psalmus David, cum esset in deserto Idum\ae \ae .
...
\Needspace{2.5\baselineskip}\versal{63}~In finem. Psalmus David.
...
\Needspace{2.5\baselineskip}\versal{64}~In finem. Psalmus David, canticum Jeremi\ae\ et Ezechielis populo transmigrationis, cum inciperent exire.
...
\Needspace{2.5\baselineskip}\versal{65}~In finem. Canticum psalmi resurrectionis. \begin{flushleft}\begin{verse}\vspace{6pt}Jubilate Deo, omnis terra~;\\
...
\Needspace{2.5\baselineskip}\versal{66}~In finem, in hymnis. Psalmus cantici David.
...
\Needspace{2.5\baselineskip}\versal{67}~In finem. Psalmus cantici ipsi David.
...
\Needspace{2.5\baselineskip}\versal{68}~In finem, pro iis qui commutabuntur. David.
...
\Needspace{2.5\baselineskip}\versal{69}~In finem. Psalmus David in rememorationem, quod salvum fecerit eum Dominus.
...
\Needspace{2.5\baselineskip}\versal{70}~Psalmus David, filiorum Jonadab, et priorum captivorum. \begin{flushleft}\begin{verse}\vspace{6pt}In te, Domine, speravi~; non confundar in \ae ternum.\\
...
\Needspace{2.5\baselineskip}\versal{71}~Psalmus, in Salomonem.
...
\Needspace{2.5\baselineskip}\versal{72}~Psalmus Asaph. \begin{flushleft}\begin{verse}\vspace{6pt}Quam bonus Isra\"el Deus,\\ his qui recto sunt corde~!\\
...
\Needspace{2.5\baselineskip}\versal{73}~Intellectus Asaph. \begin{flushleft}\begin{verse}\vspace{6pt}Ut quid, Deus, repulisti in finem,\\ iratus est furor tuus super oves pascu\ae\ tu\ae~?\\
...
\Needspace{2.5\baselineskip}\versal{74}~In finem, ne corrumpas. Psalmus cantici Asaph.
...
\Needspace{2.5\baselineskip}\versal{75}~In finem, in laudibus. Psalmus Asaph, canticum ad Assyrios.
...
\Needspace{2.5\baselineskip}\versal{76}~In finem, pro Idithun. Psalmus Asaph.
...
\Needspace{2.5\baselineskip}\versal{77}~Intellectus Asaph. \begin{flushleft}\begin{verse}\vspace{6pt}Attendite, popule meus, legem meam~;\\ inclinate aurem vestram in verba oris mei.\\
...
\Needspace{2.5\baselineskip}\versal{78}~Psalmus Asaph. \begin{flushleft}\begin{verse}\vspace{6pt}Deus, venerunt gentes in h\ae reditatem tuam~;\\ polluerunt templum sanctum tuum~;\\ posuerunt Jerusalem in pomorum custodiam.\\
...
\Needspace{2.5\baselineskip}\versal{79}~In finem, pro iis qui commutabuntur. Testimonium Asaph, psalmus.
...
\Needspace{2.5\baselineskip}\versal{80}~In finem, pro torcularibus. Psalmus ipsi Asaph.
...
\Needspace{2.5\baselineskip}\versal{81}~Psalmus Asaph. \begin{flushleft}\begin{verse}\vspace{6pt}Deus stetit in synagoga deorum~;\\ in medio autem deos dijudicat.\\
...
\Needspace{2.5\baselineskip}\versal{82}~Canticum Psalmi Asaph.
...
\Needspace{2.5\baselineskip}\versal{83}~In finem, pro torcularibus filiis Core. Psalmus.
...
\Needspace{2.5\baselineskip}\versal{84}~In finem, filiis Core. Psalmus.
...
\Needspace{2.5\baselineskip}\versal{85}~Oratio ipsi David. \begin{flushleft}\begin{verse}\vspace{6pt}Inclina, Domine, aurem tuam et exaudi me,\\ quoniam inops et pauper sum ego.\\
...
\Needspace{2.5\baselineskip}\versal{86}~Filiis Core. Psalmus cantici. \begin{flushleft}\begin{verse}\vspace{6pt}Fundamenta ejus in montibus sanctis~;\\
...
\Needspace{2.5\baselineskip}\versal{87}~Canticum Psalmi, filiis Core, in finem, pro Maheleth ad respondendum. Intellectus Eman Ezrahit\ae .
...
\Needspace{2.5\baselineskip}\versal{88}~Intellectus Ethan Ezrahit\ae .
...
\Needspace{2.5\baselineskip}\versal{89}~Oratio Moysi, hominis Dei. \begin{flushleft}\begin{verse}\vspace{6pt}Domine, refugium factus es nobis\\ a generatione in generationem.\\
...
\Needspace{2.5\baselineskip}\versal{90}~Laus cantici David. \begin{flushleft}\begin{verse}\vspace{6pt}Qui habitat in adjutorio Altissimi,\\ in protectione Dei c\ae li commorabitur.\\
...
\Needspace{2.5\baselineskip}\versal{91}~Psalmus cantici, in die sabbati.
...
\Needspace{2.5\baselineskip}\versal{92}~Laus cantici ipsi David, in die ante sabbatum, quando fundata est terra. \begin{flushleft}\begin{verse}\vspace{6pt}Dominus regnavit, decorem indutus est~:\\ indutus est Dominus fortitudinem, et pr\ae cinxit se.\\ Etenim firmavit orbem terr\ae , qui non commovebitur.\\
...
\Needspace{2.5\baselineskip}\versal{93}~Psalmus ipsi David, quarta sabbati. \begin{flushleft}\begin{verse}\vspace{6pt}Deus ultionum Dominus~;\\ Deus ultionum libere egit.\\
...
\Needspace{2.5\baselineskip}\versal{94}~Laus cantici ipsi David. \begin{flushleft}\begin{verse}\vspace{6pt}Venite, exsultemus Domino~;\\ jubilemus Deo salutari nostro~;\\
...
\Needspace{2.5\baselineskip}\versal{95}~Canticum ipsi David, quando domus \ae dificabatur post captivitatem. \begin{flushleft}\begin{verse}\vspace{6pt}Cantate Domino canticum novum~;\\ cantate Domino omnis terra.\\
...
\Needspace{2.5\baselineskip}\versal{96}~Huic David, quando terra ejus restituta est. \begin{flushleft}\begin{verse}\vspace{6pt}Dominus regnavit~: exsultet terra~;\\ l\ae tentur insul\ae\ mult\ae .\\
...
\Needspace{2.5\baselineskip}\versal{97}~Psalmus ipsi David. \begin{flushleft}\begin{verse}\vspace{6pt}Cantate Domino canticum novum,\\ quia mirabilia fecit.\\ Salvavit sibi dextera ejus,\\ et brachium sanctum ejus.\\
...
\Needspace{2.5\baselineskip}\versal{98}~Psalmus ipsi David. \begin{flushleft}\begin{verse}\vspace{6pt}Dominus regnavit~: irascantur populi~;\\ qui sedet super cherubim~: moveatur terra.\\
...
\Needspace{2.5\baselineskip}\versal{99}~Psalmus in confessione.
...
\Needspace{2.5\baselineskip}\versal{100}~Psalmus ipsi David. \begin{flushleft}\begin{verse}\vspace{6pt}Misericordiam et judicium cantabo tibi, Domine~;\\ psallam,
...
\Needspace{2.5\baselineskip}\versal{101}~Oratio pauperis, cum anxius fuerit, et in conspectu Domini effuderit precem suam.
...
\Needspace{2.5\baselineskip}\versal{102}~Ipsi David. \begin{flushleft}\begin{verse}\vspace{6pt}Benedic, anima mea, Domino,\\ et omnia qu\ae\ intra me sunt nomini sancto ejus.\\
...
\Needspace{2.5\baselineskip}\versal{103}~Ipsi David. \begin{flushleft}\begin{verse}\vspace{6pt}Benedic, anima mea, Domino~:\\ Domine Deus meus, magnificatus es vehementer.\\ Confessionem et decorem induisti,\\
...
\Needspace{2.5\baselineskip}\versal{104}~Alleluja. \begin{flushleft}\begin{verse}\vspace{6pt}Confitemini Domino, et invocate nomen ejus~;\\ annuntiate inter gentes opera ejus.\\
...
\Needspace{2.5\baselineskip}\versal{105}~Alleluja. \begin{flushleft}\begin{verse}\vspace{6pt}Confitemini Domino, quoniam bonus,\\ quoniam in s\ae culum misericordia ejus.\\
...
\Needspace{2.5\baselineskip}\versal{106}~Alleluja. \begin{flushleft}\begin{verse}\vspace{6pt}Confitemini Domino, quoniam bonus,\\ quoniam in s\ae culum misericordia ejus.\\
...
\Needspace{2.5\baselineskip}\versal{107}~Canticum Psalmi, ipsi David.
...
\Needspace{2.5\baselineskip}\versal{108}~In finem. Psalmus David.
...
\Needspace{2.5\baselineskip}\versal{109}~Psalmus David. \begin{flushleft}\begin{verse}\vspace{6pt}Dixit Dominus Domino meo~:\\ Sede a dextris meis,\\ donec ponam inimicos tuos scabellum pedum tuorum.\\
...
\Needspace{2.5\baselineskip}\versal{110}~Alleluja. \begin{flushleft}\begin{verse}\vspace{6pt}Confitebor tibi, Domine, in toto corde meo,\\ in consilio justorum, et congregatione.\\
...
\Needspace{2.5\baselineskip}\versal{111}~Alleluja, reversionis Agg\ae i et Zachari\ae . \begin{flushleft}\begin{verse}\vspace{6pt}Beatus vir qui timet Dominum~:\\ in mandatis ejus volet nimis.\\
...
\Needspace{2.5\baselineskip}\versal{112}~Alleluja. \begin{flushleft}\begin{verse}\vspace{6pt}Laudate, pueri, Dominum~;\\ laudate nomen Domini.\\
...
\Needspace{2.5\baselineskip}\versal{113}~Alleluja. \begin{flushleft}\begin{verse}\vspace{6pt}In exitu Isra\"el de \AE gypto,\\ domus Jacob de populo barbaro,\\
...
\Needspace{2.5\baselineskip}\versal{114}~Alleluja. \begin{flushleft}\begin{verse}\vspace{6pt}Dilexi, quoniam exaudiet Dominus\\ vocem orationis me\ae .\\
...
\Needspace{2.5\baselineskip}\versal{115}~Alleluja. \begin{flushleft}\begin{verse}\vspace{6pt}Credidi, propter quod locutus sum~;\\ ego autem humiliatus sum nimis.\\
...
\Needspace{2.5\baselineskip}\versal{116}~Alleluja. \begin{flushleft}\begin{verse}\vspace{6pt}Laudate Dominum, omnes gentes~;\\ laudate eum, omnes populi.\\
${}^{2}$~Quoniam confirmata est super nos misericordia ejus,\\ et veritas Domini manet in \ae ternum.\end{verse}\end{flushleft}


\Needspace{2.5\baselineskip}\versal{117}~Alleluja. \begin{flushleft}\begin{verse}\vspace{6pt}Confitemini Domino, quoniam bonus,\\ quoniam in s\ae culum misericordia ejus.\\
...
\Needspace{2.5\baselineskip}\versal{118}~Alleluja. \begin{flushleft}\begin{verse}\vspace{6pt}\textsc{Aleph.} Beati immaculati in via,\\ qui ambulant in lege Domini.\\
...
\Needspace{2.5\baselineskip}\versal{119}~Canticum graduum. \begin{flushleft}\begin{verse}\vspace{6pt}Ad Dominum cum tribularer clamavi,\\ et exaudivit me.\\
...
\Needspace{2.5\baselineskip}\versal{120}~Canticum graduum. \begin{flushleft}\begin{verse}\vspace{6pt}Levavi oculos meos in montes,\\ unde veniet auxilium mihi.\\
...
\Needspace{2.5\baselineskip}\versal{121}~Canticum graduum. \begin{flushleft}\begin{verse}\vspace{6pt}L\ae tatus sum in his qu\ae\ dicta sunt mihi~:\\ In domum Domini ibimus.\\
...
\Needspace{2.5\baselineskip}\versal{122}~Canticum graduum. \begin{flushleft}\begin{verse}\vspace{6pt}Ad te levavi oculos meos,\\ qui habitas in c\ae lis.\\
...
\Needspace{2.5\baselineskip}\versal{123}~Canticum graduum. \begin{flushleft}\begin{verse}\vspace{6pt}Nisi quia Dominus erat in nobis,\\ dicat nunc Isra\"el,\\
...
\Needspace{2.5\baselineskip}\versal{124}~Canticum graduum. \begin{flushleft}\begin{verse}\vspace{6pt}Qui confidunt in Domino, sicut mons Sion~:\\ non commovebitur in \ae ternum,\\ qui habitat
...
\Needspace{2.5\baselineskip}\versal{125}~Canticum graduum. \begin{flushleft}\begin{verse}\vspace{6pt}In convertendo Dominus captivitatem Sion,\\ facti sumus sicut consolati.\\
...
\Needspace{2.5\baselineskip}\versal{126}~Canticum graduum Salomonis. \begin{flushleft}\begin{verse}\vspace{6pt}Nisi Dominus \ae dificaverit domum,\\ in vanum laboraverunt qui \ae dificant eam.\\ Nisi Dominus custodierit civitatem,\\ frustra vigilat qui custodit eam.\\
...
\Needspace{2.5\baselineskip}\versal{127}~Canticum graduum. \begin{flushleft}\begin{verse}\vspace{6pt}Beati omnes qui timent Dominum,\\ qui ambulant in viis ejus.\\
...
\Needspace{2.5\baselineskip}\versal{128}~Canticum graduum. \begin{flushleft}\begin{verse}\vspace{6pt}S\ae pe expugnaverunt me a juventute mea,\\ dicat nunc Isra\"el~;\\
...
\Needspace{2.5\baselineskip}\versal{129}~Canticum graduum. \begin{flushleft}\begin{verse}\vspace{6pt}De profundis clamavi ad te, Domine~;\\
...
\Needspace{2.5\baselineskip}\versal{130}~Canticum graduum David. \begin{flushleft}\begin{verse}\vspace{6pt}Domine, non est exaltatum cor meum,\\ neque elati sunt oculi mei,\\ neque ambulavi in magnis,\\ neque in mirabilibus super me.\\
...
\Needspace{2.5\baselineskip}\versal{131}~Canticum graduum. \begin{flushleft}\begin{verse}\vspace{6pt}Memento, Domine, David,\\ et omnis mansuetudinis ejus~:\\
...
\Needspace{2.5\baselineskip}\versal{132}~Canticum graduum David. \begin{flushleft}\begin{verse}\vspace{6pt}Ecce quam bonum et quam jucundum,\\ habitare fratres in unum~!\\
...
\Needspace{2.5\baselineskip}\versal{133}~Canticum graduum. \begin{flushleft}\begin{verse}\vspace{6pt}Ecce nunc benedicite Dominum, omnes servi Domini~:\\ qui statis in domo Domini,\\ in atriis domus Dei nostri.\\
...
\Needspace{2.5\baselineskip}\versal{134}~Alleluja. \begin{flushleft}\begin{verse}\vspace{6pt}Laudate nomen Domini~;\\ laudate, servi, Dominum~:\\
...
\Needspace{2.5\baselineskip}\versal{135}~Alleluja. \begin{flushleft}\begin{verse}\vspace{6pt}Confitemini Domino, quoniam bonus,\\ quoniam in \ae ternum misericordia ejus.\\
...
\Needspace{2.5\baselineskip}\versal{136}~Psalmus David, Jeremi\ae . \begin{flushleft}\begin{verse}\vspace{6pt}Super flumina Babylonis illic sedimus et flevimus,\\ cum recordaremur Sion.\\
...
\Needspace{2.5\baselineskip}\versal{137}~Ipsi David. \begin{flushleft}\begin{verse}\vspace{6pt}Confitebor tibi, Domine, in toto corde meo,\\ quoniam audisti verba oris mei.\\ In conspectu angelorum psallam tibi~;\\
...
\Needspace{2.5\baselineskip}\versal{138}~In finem, psalmus David. \begin{flushleft}\begin{verse}\vspace{6pt}Domine, probasti me, et cognovisti me~;\\
...
\Needspace{2.5\baselineskip}\versal{139}~In finem. Psalmus David.
...
\Needspace{2.5\baselineskip}\versal{140}~Psalmus David. \begin{flushleft}\begin{verse}\vspace{6pt}Domine, clamavi ad te~: exaudi me~;\\ intende voci me\ae , cum clamavero ad te.\\
...
\Needspace{2.5\baselineskip}\versal{141}~Intellectus David, cum esset in spelunca, oratio.
...
\Needspace{2.5\baselineskip}\versal{142}~Psalmus David, quando persequebatur eum Absalom filius ejus. \begin{flushleft}\begin{verse}\vspace{6pt}Domine, exaudi orationem meam~;\\ auribus percipe obsecrationem meam in veritate tua~;\\ exaudi me in tua justitia.\\
...
\Needspace{2.5\baselineskip}\versal{143}~Psalmus David. Adversus Goliath. \begin{flushleft}\begin{verse}\vspace{6pt}Benedictus Dominus Deus meus,\\ qui docet manus meas ad pr\ae lium,\\ et digitos meos ad bellum.\\
...
\Needspace{2.5\baselineskip}\versal{144}~Laudatio ipsi David. \begin{flushleft}\begin{verse}\vspace{6pt}Exaltabo te, Deus meus rex,\\ et benedicam nomini tuo in s\ae culum, et in s\ae culum s\ae culi.\\
...
\Needspace{2.5\baselineskip}\versal{145}~Alleluja, Agg\ae i et Zachari\ae .
...
\Needspace{2.5\baselineskip}\versal{146}~Alleluja. \begin{flushleft}\begin{verse}\vspace{6pt}Laudate Dominum, quoniam bonus est psalmus~;\\ Deo nostro sit jucunda, decoraque laudatio.\\
...
\Needspace{2.5\baselineskip}\versal{147}~Alleluja. \begin{flushleft}\begin{verse}\vspace{6pt}Lauda, Jerusalem, Dominum~;\\ lauda Deum tuum, Sion.\\
...
\Needspace{2.5\baselineskip}\versal{148}~Alleluja. \begin{flushleft}\begin{verse}\vspace{6pt}Laudate Dominum de c\ae lis~;\\ laudate eum in excelsis.\\
...
\Needspace{2.5\baselineskip}\versal{149}~Alleluja. \begin{flushleft}\begin{verse}\vspace{6pt}Cantate Domino canticum novum~;\\ laus ejus in ecclesia sanctorum.\\
...
\Needspace{2.5\baselineskip}\versal{150}~Alleluja. \begin{flushleft}\begin{verse}\vspace{6pt}Laudate Dominum in sanctis ejus~;\\ laudate eum in firmamento virtutis ejus.\\
