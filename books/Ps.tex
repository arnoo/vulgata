...
\bchapter
\mylettrine{I}n finem. Psalmus David. \begin{flushleft}\begin{verse}\vspace{6pt}Usquequo, Domine, oblivisceris me in finem~?\\ usquequo avertis faciem tuam a me~?\\
...
\bchapter
\mylettrine{I}n finem. Psalmus David. \begin{flushleft}\begin{verse}\vspace{6pt}Dixit insipiens in corde suo~: Non est Deus.\\ Corrupti sunt, et abominabiles facti sunt in studiis suis~;\\ non est qui faciat bonum, non est usque ad unum.\\
...
\bchapter
\mylettrine{P}salmus David. \begin{flushleft}\begin{verse}\vspace{6pt}Domine, quis habitabit in tabernaculo tuo~?\\ aut quis requiescet in monte sancto tuo~?\\
...
\bchapter
\mylettrine{T}ituli inscriptio, ipsi David. \begin{flushleft}\begin{verse}\vspace{6pt}Conserva me, Domine, quoniam speravi in te.\\
...
\bchapter
\mylettrine{O}ratio David. \begin{flushleft}\begin{verse}\vspace{6pt}Exaudi, Domine, justitiam meam~;\\ intende deprecationem meam.\\ Auribus percipe orationem meam,\\ non in labiis dolosis.\\
...
\bchapter
\mylettrine{P}salmus David. \begin{flushleft}\begin{verse}\vspace{6pt}Dominus regit me, et nihil mihi deerit~:\\
...
\bchapter
\mylettrine{P}rima sabbati. Psalmus David. \begin{flushleft}\begin{verse}\vspace{6pt}Domini est terra, et plenitudo ejus~;\\ orbis terrarum, et universi qui habitant in eo.\\
...
\bchapter
\mylettrine{I}n finem. Psalmus David. \begin{flushleft}\begin{verse}\vspace{6pt}Ad te, Domine, levavi animam meam~:\\
...
\bchapter
\mylettrine{I}n finem. Psalmus David. \begin{flushleft}\begin{verse}\vspace{6pt}Judica me, Domine, quoniam ego in innocentia mea ingressus sum,\\ et in Domino sperans non infirmabor.\\
...
\bchapter
\mylettrine{P}salmus David, priusquam liniretur. \begin{flushleft}\begin{verse}\vspace{6pt}Dominus illuminatio mea et salus mea~: quem timebo~?\\ Dominus protector vit\ae\ me\ae~:\\ a quo trepidabo~?\\
...
\bchapter
\mylettrine{P}salmus ipsi David. \begin{flushleft}\begin{verse}\vspace{6pt}Ad te, Domine, clamabo~; Deus meus, ne sileas a me~:\\ nequando taceas a me, et assimilabor descendentibus in lacum.\\
...
\bchapter
\mylettrine{P}salmus David, in consummatione tabernaculi. \begin{flushleft}\begin{verse}\vspace{6pt}Afferte Domino, filii Dei,\\ afferte Domino filios arietum.\\
...
\bchapter
\mylettrine{I}psi David intellectus. \begin{flushleft}\begin{verse}\vspace{6pt}Beati quorum remiss\ae\ sunt iniquitates,\\ et quorum tecta sunt peccata.\\
...
\bchapter
\mylettrine{P}salmus David. \begin{flushleft}\begin{verse}\vspace{6pt}Exsultate, justi, in Domino~;\\ rectos decet collaudatio.\\
...
\bchapter
\mylettrine{I}psi David. \begin{flushleft}\begin{verse}\vspace{6pt}Judica, Domine, nocentes me~;\\ expugna impugnantes me.\\
...
\bchapter
\mylettrine{P}salmus ipsi David. \begin{flushleft}\begin{verse}\vspace{6pt}Noli \ae mulari in malignantibus,\\ neque zelaveris facientes iniquitatem~:\\
...
\bchapter
\mylettrine{P}salmus David. \begin{flushleft}\begin{verse}\vspace{6pt}Judica me, Deus, et discerne causam meam de gente non sancta~:\\ ab homine iniquo et doloso erue me.\\
...
\bchapter
\mylettrine{P}salmus Asaph. \begin{flushleft}\begin{verse}\vspace{6pt}Deus deorum Dominus locutus est,\\ et vocavit terram a solis ortu usque ad occasum.\\
...
\bchapter
\mylettrine{I}n finem, pro Ma\"eleth intelligenti\ae\ David. \begin{flushleft}\begin{verse}\vspace{6pt}Dixit insipiens in corde suo~: Non est Deus.\\
...
\bchapter
\mylettrine{I}n finem. Canticum psalmi resurrectionis. \begin{flushleft}\begin{verse}\vspace{6pt}Jubilate Deo, omnis terra~;\\
...
\bchapter
\mylettrine{P}salmus David, filiorum Jonadab, et priorum captivorum. \begin{flushleft}\begin{verse}\vspace{6pt}In te, Domine, speravi~; non confundar in \ae ternum.\\
...
\bchapter
\mylettrine{P}salmus Asaph. \begin{flushleft}\begin{verse}\vspace{6pt}Quam bonus Isra\"el Deus,\\ his qui recto sunt corde~!\\
...
\bchapter
\mylettrine{I}ntellectus Asaph. \begin{flushleft}\begin{verse}\vspace{6pt}Ut quid, Deus, repulisti in finem,\\ iratus est furor tuus super oves pascu\ae\ tu\ae~?\\
...
\bchapter
\mylettrine{I}ntellectus Asaph. \begin{flushleft}\begin{verse}\vspace{6pt}Attendite, popule meus, legem meam~;\\ inclinate aurem vestram in verba oris mei.\\
...
\bchapter
\mylettrine{P}salmus Asaph. \begin{flushleft}\begin{verse}\vspace{6pt}Deus, venerunt gentes in h\ae reditatem tuam~;\\ polluerunt templum sanctum tuum~;\\ posuerunt Jerusalem in pomorum custodiam.\\
...
\bchapter
\mylettrine{P}salmus Asaph. \begin{flushleft}\begin{verse}\vspace{6pt}Deus stetit in synagoga deorum~;\\ in medio autem deos dijudicat.\\
...
\bchapter
\mylettrine{O}ratio ipsi David. \begin{flushleft}\begin{verse}\vspace{6pt}Inclina, Domine, aurem tuam et exaudi me,\\ quoniam inops et pauper sum ego.\\
...
\bchapter
\mylettrine{F}iliis Core. Psalmus cantici. \begin{flushleft}\begin{verse}\vspace{6pt}Fundamenta ejus in montibus sanctis~;\\
...
\bchapter
\mylettrine{O}ratio Moysi, hominis Dei. \begin{flushleft}\begin{verse}\vspace{6pt}Domine, refugium factus es nobis\\ a generatione in generationem.\\
...
\bchapter
\mylettrine{L}aus cantici David. \begin{flushleft}\begin{verse}\vspace{6pt}Qui habitat in adjutorio Altissimi,\\ in protectione Dei c\ae li commorabitur.\\
...
\bchapter
\mylettrine{L}aus cantici ipsi David, in die ante sabbatum, quando fundata est terra. \begin{flushleft}\begin{verse}\vspace{6pt}Dominus regnavit, decorem indutus est~:\\ indutus est Dominus fortitudinem, et pr\ae cinxit se.\\ Etenim firmavit orbem terr\ae , qui non commovebitur.\\
...
\bchapter
\mylettrine{P}salmus ipsi David, quarta sabbati. \begin{flushleft}\begin{verse}\vspace{6pt}Deus ultionum Dominus~;\\ Deus ultionum libere egit.\\
...
\bchapter
\mylettrine{L}aus cantici ipsi David. \begin{flushleft}\begin{verse}\vspace{6pt}Venite, exsultemus Domino~;\\ jubilemus Deo salutari nostro~;\\
...
\bchapter
\mylettrine{C}anticum ipsi David, quando domus \ae dificabatur post captivitatem. \begin{flushleft}\begin{verse}\vspace{6pt}Cantate Domino canticum novum~;\\ cantate Domino omnis terra.\\
...
\bchapter
\mylettrine{H}uic David, quando terra ejus restituta est. \begin{flushleft}\begin{verse}\vspace{6pt}Dominus regnavit~: exsultet terra~;\\ l\ae tentur insul\ae\ mult\ae .\\
...
\bchapter
\mylettrine{P}salmus ipsi David. \begin{flushleft}\begin{verse}\vspace{6pt}Cantate Domino canticum novum,\\ quia mirabilia fecit.\\ Salvavit sibi dextera ejus,\\ et brachium sanctum ejus.\\
...
\bchapter
\mylettrine{P}salmus ipsi David. \begin{flushleft}\begin{verse}\vspace{6pt}Dominus regnavit~: irascantur populi~;\\ qui sedet super cherubim~: moveatur terra.\\
...
\bchapter
\mylettrine{P}salmus ipsi David. \begin{flushleft}\begin{verse}\vspace{6pt}Misericordiam et judicium cantabo tibi, Domine~;\\ psallam,
...
\bchapter
\mylettrine{I}psi David. \begin{flushleft}\begin{verse}\vspace{6pt}Benedic, anima mea, Domino,\\ et omnia qu\ae\ intra me sunt nomini sancto ejus.\\
...
\bchapter
\mylettrine{I}psi David. \begin{flushleft}\begin{verse}\vspace{6pt}Benedic, anima mea, Domino~:\\ Domine Deus meus, magnificatus es vehementer.\\ Confessionem et decorem induisti,\\
...
\bchapter
\mylettrine{A}lleluja. \begin{flushleft}\begin{verse}\vspace{6pt}Confitemini Domino, et invocate nomen ejus~;\\ annuntiate inter gentes opera ejus.\\
...
\bchapter
\mylettrine{A}lleluja. \begin{flushleft}\begin{verse}\vspace{6pt}Confitemini Domino, quoniam bonus,\\ quoniam in s\ae culum misericordia ejus.\\
...
\bchapter
\mylettrine{P}salmus David. \begin{flushleft}\begin{verse}\vspace{6pt}Dixit Dominus Domino meo~:\\ Sede a dextris meis,\\ donec ponam inimicos tuos scabellum pedum tuorum.\\
...
\bchapter
\mylettrine{A}lleluja. \begin{flushleft}\begin{verse}\vspace{6pt}Confitebor tibi, Domine, in toto corde meo,\\ in consilio justorum, et congregatione.\\
...
\bchapter
\mylettrine{A}lleluja, reversionis Agg\ae i et Zachari\ae . \begin{flushleft}\begin{verse}\vspace{6pt}Beatus vir qui timet Dominum~:\\ in mandatis ejus volet nimis.\\
...
\bchapter
\mylettrine{A}lleluja. \begin{flushleft}\begin{verse}\vspace{6pt}Laudate, pueri, Dominum~;\\ laudate nomen Domini.\\
...
\bchapter
\mylettrine{A}lleluja. \begin{flushleft}\begin{verse}\vspace{6pt}In exitu Isra\"el de \AE gypto,\\ domus Jacob de populo barbaro,\\
...
\bchapter
\mylettrine{A}lleluja. \begin{flushleft}\begin{verse}\vspace{6pt}Dilexi, quoniam exaudiet Dominus\\ vocem orationis me\ae .\\
...
\bchapter
\mylettrine{A}lleluja. \begin{flushleft}\begin{verse}\vspace{6pt}Credidi, propter quod locutus sum~;\\ ego autem humiliatus sum nimis.\\
...
\bchapter
\mylettrine{A}lleluja. \begin{flushleft}\begin{verse}\vspace{6pt}Laudate Dominum, omnes gentes~;\\ laudate eum, omnes populi.\\
...
\bchapter
\mylettrine{A}lleluja. \begin{flushleft}\begin{verse}\vspace{6pt}\textsc{Aleph.} Beati immaculati in via,\\ qui ambulant in lege Domini.\\
...
\bchapter
\mylettrine{C}anticum graduum. \begin{flushleft}\begin{verse}\vspace{6pt}Ad Dominum cum tribularer clamavi,\\ et exaudivit me.\\
...
\bchapter
\mylettrine{C}anticum graduum. \begin{flushleft}\begin{verse}\vspace{6pt}Levavi oculos meos in montes,\\ unde veniet auxilium mihi.\\
...
\bchapter
\mylettrine{C}anticum graduum. \begin{flushleft}\begin{verse}\vspace{6pt}L\ae tatus sum in his qu\ae\ dicta sunt mihi~:\\ In domum Domini ibimus.\\
...
\bchapter
\mylettrine{C}anticum graduum. \begin{flushleft}\begin{verse}\vspace{6pt}Ad te levavi oculos meos,\\ qui habitas in c\ae lis.\\
...
\bchapter
\mylettrine{C}anticum graduum. \begin{flushleft}\begin{verse}\vspace{6pt}Nisi quia Dominus erat in nobis,\\ dicat nunc Isra\"el,\\
...
\bchapter
\mylettrine{C}anticum graduum. \begin{flushleft}\begin{verse}\vspace{6pt}Qui confidunt in Domino, sicut mons Sion~:\\ non commovebitur in \ae ternum,\\ qui habitat
...
\bchapter
\mylettrine{C}anticum graduum. \begin{flushleft}\begin{verse}\vspace{6pt}In convertendo Dominus captivitatem Sion,\\ facti sumus sicut consolati.\\
...
\bchapter
\mylettrine{C}anticum graduum Salomonis. \begin{flushleft}\begin{verse}\vspace{6pt}Nisi Dominus \ae dificaverit domum,\\ in vanum laboraverunt qui \ae dificant eam.\\ Nisi Dominus custodierit civitatem,\\ frustra vigilat qui custodit eam.\\
...
\bchapter
\mylettrine{C}anticum graduum. \begin{flushleft}\begin{verse}\vspace{6pt}Beati omnes qui timent Dominum,\\ qui ambulant in viis ejus.\\
...
\bchapter
\mylettrine{C}anticum graduum. \begin{flushleft}\begin{verse}\vspace{6pt}S\ae pe expugnaverunt me a juventute mea,\\ dicat nunc Isra\"el~;\\
...
\bchapter
\mylettrine{C}anticum graduum. \begin{flushleft}\begin{verse}\vspace{6pt}De profundis clamavi ad te, Domine~;\\
...
\bchapter
\mylettrine{C}anticum graduum David. \begin{flushleft}\begin{verse}\vspace{6pt}Domine, non est exaltatum cor meum,\\ neque elati sunt oculi mei,\\ neque ambulavi in magnis,\\ neque in mirabilibus super me.\\
...
\bchapter
\mylettrine{C}anticum graduum. \begin{flushleft}\begin{verse}\vspace{6pt}Memento, Domine, David,\\ et omnis mansuetudinis ejus~:\\
...
\bchapter
\mylettrine{C}anticum graduum David. \begin{flushleft}\begin{verse}\vspace{6pt}Ecce quam bonum et quam jucundum,\\ habitare fratres in unum~!\\
...
\bchapter
\mylettrine{C}anticum graduum. \begin{flushleft}\begin{verse}\vspace{6pt}Ecce nunc benedicite Dominum, omnes servi Domini~:\\ qui statis in domo Domini,\\ in atriis domus Dei nostri.\\
...
\bchapter
\mylettrine{A}lleluja. \begin{flushleft}\begin{verse}\vspace{6pt}Laudate nomen Domini~;\\ laudate, servi, Dominum~:\\
...
\bchapter
\mylettrine{A}lleluja. \begin{flushleft}\begin{verse}\vspace{6pt}Confitemini Domino, quoniam bonus,\\ quoniam in \ae ternum misericordia ejus.\\
...
\bchapter
\mylettrine{P}salmus David, Jeremi\ae . \begin{flushleft}\begin{verse}\vspace{6pt}Super flumina Babylonis illic sedimus et flevimus,\\ cum recordaremur Sion.\\
...
\bchapter
\mylettrine{I}psi David. \begin{flushleft}\begin{verse}\vspace{6pt}Confitebor tibi, Domine, in toto corde meo,\\ quoniam audisti verba oris mei.\\ In conspectu angelorum psallam tibi~;\\
...
\bchapter
\mylettrine{I}n finem, psalmus David. \begin{flushleft}\begin{verse}\vspace{6pt}Domine, probasti me, et cognovisti me~;\\
...
\bchapter
\mylettrine{P}salmus David. \begin{flushleft}\begin{verse}\vspace{6pt}Domine, clamavi ad te~: exaudi me~;\\ intende voci me\ae , cum clamavero ad te.\\
...
\bchapter
\mylettrine{P}salmus David, quando persequebatur eum Absalom filius ejus. \begin{flushleft}\begin{verse}\vspace{6pt}Domine, exaudi orationem meam~;\\ auribus percipe obsecrationem meam in veritate tua~;\\ exaudi me in tua justitia.\\
...
\bchapter
\mylettrine{P}salmus David. Adversus Goliath. \begin{flushleft}\begin{verse}\vspace{6pt}Benedictus Dominus Deus meus,\\ qui docet manus meas ad pr\ae lium,\\ et digitos meos ad bellum.\\
...
\bchapter
\mylettrine{L}audatio ipsi David. \begin{flushleft}\begin{verse}\vspace{6pt}Exaltabo te, Deus meus rex,\\ et benedicam nomini tuo in s\ae culum, et in s\ae culum s\ae culi.\\
...
\bchapter
\mylettrine{A}lleluja. \begin{flushleft}\begin{verse}\vspace{6pt}Laudate Dominum, quoniam bonus est psalmus~;\\ Deo nostro sit jucunda, decoraque laudatio.\\
...
\bchapter
\mylettrine{A}lleluja. \begin{flushleft}\begin{verse}\vspace{6pt}Lauda, Jerusalem, Dominum~;\\ lauda Deum tuum, Sion.\\
...
\bchapter
\mylettrine{A}lleluja. \begin{flushleft}\begin{verse}\vspace{6pt}Laudate Dominum de c\ae lis~;\\ laudate eum in excelsis.\\
...
\bchapter
\mylettrine{A}lleluja. \begin{flushleft}\begin{verse}\vspace{6pt}Cantate Domino canticum novum~;\\ laus ejus in ecclesia sanctorum.\\
...
\bchapter
\mylettrine{A}lleluja. \begin{flushleft}\begin{verse}\vspace{6pt}Laudate Dominum in sanctis ejus~;\\ laudate eum in firmamento virtutis ejus.\\
