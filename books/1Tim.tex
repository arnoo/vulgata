...
\Needspace{2.5\baselineskip}\versal{1}~Paulus Apostolus Jesu Christi secundum imperium Dei Salvatoris nostri, et Christi Jesu spei nostr\ae ,
...
\Needspace{2.5\baselineskip}\versal{2}~Obsecro igitur primum omnium fieri obsecrationes, orationes, postulationes, gratiarum actiones, pro omnibus hominibus~:
...
\Needspace{2.5\baselineskip}\versal{3}~Fidelis sermo~: si quis episcopatum desiderat, bonum opus desiderat.
...
\Needspace{2.5\baselineskip}\versal{4}~Spiritus autem manifeste dicit, quia in novissimis temporibus discedent quidam a fide, attendentes spiritibus erroris, et doctrinis d\ae moniorum,
...
\Needspace{2.5\baselineskip}\versal{5}~Seniorem ne increpaveris, sed obsecra ut patrem~: juvenes, ut fratres~:
...
\Needspace{2.5\baselineskip}\versal{6}~Quicumque sunt sub jugo servi, dominos suos omni honore dignos arbitrentur, ne nomen Domini et doctrina blasphemetur.
